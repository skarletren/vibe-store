 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,H){var Y=B.length;B.push(H);e:for(;0<Y;){var ie=Y-1>>>1,le=B[ie];if(0<i(le,H))B[ie]=H,B[Y]=le,Y=ie;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var H=B[0],Y=B.pop();if(Y!==H){B[0]=Y;e:for(var ie=0,le=B.length,ge=le>>>1;ie<ge;){var Et=2*(ie+1)-1,gt=B[Et],Vt=Et+1,Wt=B[Vt];if(0>i(gt,Y))Vt<le&&0>i(Wt,gt)?(B[ie]=Wt,B[Vt]=Y,ie=Vt):(B[ie]=gt,B[Et]=Y,ie=Et);else if(Vt<le&&0>i(Wt,Y))B[ie]=Wt,B[Vt]=Y,ie=Vt;else break e}}return H}function i(B,H){var Y=B.sortIndex-H.sortIndex;return Y!==0?Y:B.id-H.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var u=[],c=[],d=1,f=null,p=3,g=!1,T=!1,P=!1,R=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function I(B){for(var H=n(c);H!==null;){if(H.callback===null)r(c);else if(H.startTime<=B)r(c),H.sortIndex=H.expirationTime,e(u,H);else break;H=n(c)}}function V(B){if(P=!1,I(B),!T)if(n(u)!==null)T=!0,Ee(M);else{var H=n(c);H!==null&&ot(V,H.startTime-B)}}function M(B,H){T=!1,P&&(P=!1,x(y),y=-1),g=!0;var Y=p;try{for(I(H),f=n(u);f!==null&&(!(f.expirationTime>H)||B&&!k());){var ie=f.callback;if(typeof ie=="function"){f.callback=null,p=f.priorityLevel;var le=ie(f.expirationTime<=H);H=t.unstable_now(),typeof le=="function"?f.callback=le:f===n(u)&&r(u),I(H)}else r(u);f=n(u)}if(f!==null)var ge=!0;else{var Et=n(c);Et!==null&&ot(V,Et.startTime-H),ge=!1}return ge}finally{f=null,p=Y,g=!1}}var O=!1,A=null,y=-1,E=5,S=-1;function k(){return!(t.unstable_now()-S<E)}function b(){if(A!==null){var B=t.unstable_now();S=B;var H=!0;try{H=A(!0,B)}finally{H?C():(O=!1,A=null)}}else O=!1}var C;if(typeof w=="function")C=function(){w(b)};else if(typeof MessageChannel<"u"){var re=new MessageChannel,Te=re.port2;re.port1.onmessage=b,C=function(){Te.postMessage(null)}}else C=function(){R(b,0)};function Ee(B){A=B,O||(O=!0,C())}function ot(B,H){y=R(function(){B(t.unstable_now())},H)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){T||g||(T=!0,Ee(M))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return p},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(B){switch(p){case 1:case 2:case 3:var H=3;break;default:H=p}var Y=p;p=H;try{return B()}finally{p=Y}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,H){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var Y=p;p=B;try{return H()}finally{p=Y}},t.unstable_scheduleCallback=function(B,H,Y){var ie=t.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?ie+Y:ie):Y=ie,B){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=Y+le,B={id:d++,callback:H,priorityLevel:B,startTime:Y,expirationTime:le,sortIndex:-1},Y>ie?(B.sortIndex=Y,e(c,B),n(u)===null&&B===n(c)&&(P?(x(y),y=-1):P=!0,ot(V,Y-ie))):(B.sortIndex=le,e(u,B),T||g||(T=!0,Ee(M))),B},t.unstable_shouldYield=k,t.unstable_wrapCallback=function(B){var H=p;return function(){var Y=p;p=H;try{return B.apply(this,arguments)}finally{p=Y}}}})(a_);o_.exports=a_;var LS=o_.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aV=nV;function eE(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:nf,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Sr.create("bad-app-name",{appName:String(i)});if(n||(n=GT()),!n)throw Sr.create("no-options");const s=Iu.get(i);if(s){if(Su(n,s.options)&&Su(r,s.config))return s;throw Sr.create("duplicate-app",{appName:i})}const o=new fb(i);for(const u of rf.values())o.addComponent(u);const a=new oV(n,r,o);return Iu.set(i,a),a}function tE(t=nf){const e=Iu.get(t);if(!e&&t===nf&&GT())return eE();if(!e)throw Sr.create("no-app",{appName:t});return e}function An(t,e,n){var r;let i=(r=rV[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Gn.warn(a.join(" "));return}br(new qn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var hi,iE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(A,y){function E(){}E.prototype=y.prototype,A.D=y.prototype,A.prototype=new E,A.prototype.constructor=A,A.C=function(S,k,b){for(var C=Array(arguments.length-2),re=2;re<arguments.length;re++)C[re-2]=arguments[re];return y.prototype[k].apply(S,C)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(A,y,E){E||(E=0);var S=Array(16);if(typeof y=="string")for(var k=0;16>k;++k)S[k]=y.charCodeAt(E++)|y.charCodeAt(E++)<<8|y.charCodeAt(E++)<<16|y.charCodeAt(E++)<<24;else for(k=0;16>k;++k)S[k]=y[E++]|y[E++]<<8|y[E++]<<16|y[E++]<<24;y=A.g[0],E=A.g[1],k=A.g[2];var b=A.g[3],C=y+(b^E&(k^b))+S[0]+3614090360&4294967295;y=E+(C<<7&4294967295|C>>>25),C=b+(k^y&(E^k))+S[1]+3905402710&4294967295,b=y+(C<<12&4294967295|C>>>20),C=k+(E^b&(y^E))+S[2]+606105819&4294967295,k=b+(C<<17&4294967295|C>>>15),C=E+(y^k&(b^y))+S[3]+3250441966&4294967295,E=k+(C<<22&4294967295|C>>>10),C=y+(b^E&(k^b))+S[4]+4118548399&4294967295,y=E+(C<<7&4294967295|C>>>25),C=b+(k^y&(E^k))+S[5]+1200080426&4294967295,b=y+(C<<12&4294967295|C>>>20),C=k+(E^b&(y^E))+S[6]+2821735955&4294967295,k=b+(C<<17&4294967295|C>>>15),C=E+(y^k&(b^y))+S[7]+4249261313&4294967295,E=k+(C<<22&4294967295|C>>>10),C=y+(b^E&(k^b))+S[8]+1770035416&4294967295,y=E+(C<<7&4294967295|C>>>25),C=b+(k^y&(E^k))+S[9]+2336552879&4294967295,b=y+(C<<12&4294967295|C>>>20),C=k+(E^b&(y^E))+S[10]+4294925233&4294967295,k=b+(C<<17&4294967295|C>>>15),C=E+(y^k&(b^y))+S[11]+2304563134&4294967295,E=k+(C<<22&4294967295|C>>>10),C=y+(b^E&(k^b))+S[12]+1804603682&4294967295,y=E+(C<<7&4294967295|C>>>25),C=b+(k^y&(E^k))+S[13]+4254626195&4294967295,b=y+(C<<12&4294967295|C>>>20),C=k+(E^b&(y^E))+S[14]+2792965006&4294967295,k=b+(C<<17&4294967295|C>>>15),C=E+(y^k&(b^y))+S[15]+1236535329&4294967295,E=k+(C<<22&4294967295|C>>>10),C=y+(k^b&(E^k))+S[1]+4129170786&4294967295,y=E+(C<<5&4294967295|C>>>27),C=b+(E^k&(y^E))+S[6]+3225465664&4294967295,b=y+(C<<9&4294967295|C>>>23),C=k+(y^E&(b^y))+S[11]+643717713&4294967295,k=b+(C<<14&4294967295|C>>>18),C=E+(b^y&(k^b))+S[0]+3921069994&4294967295,E=k+(C<<20&4294967295|C>>>12),C=y+(k^b&(E^k))+S[5]+3593408605&4294967295,y=E+(C<<5&4294967295|C>>>27),C=b+(E^k&(y^E))+S[10]+38016083&4294967295,b=y+(C<<9&4294967295|C>>>23),C=k+(y^E&(b^y))+S[15]+3634488961&4294967295,k=b+(C<<14&4294967295|C>>>18),C=E+(b^y&(k^b))+S[4]+3889429448&4294967295,E=k+(C<<20&4294967295|C>>>12),C=y+(k^b&(E^k))+S[9]+568446438&4294967295,y=E+(C<<5&4294967295|C>>>27),C=b+(E^k&(y^E))+S[14]+3275163606&4294967295,b=y+(C<<9&4294967295|C>>>23),C=k+(y^E&(b^y))+S[3]+4107603335&4294967295,k=b+(C<<14&4294967295|C>>>18),C=E+(b^y&(k^b))+S[8]+1163531501&4294967295,E=k+(C<<20&4294967295|C>>>12),C=y+(k^b&(E^k))+S[13]+2850285829&4294967295,y=E+(C<<5&4294967295|C>>>27),C=b+(E^k&(y^E))+S[2]+4243563512&4294967295,b=y+(C<<9&4294967295|C>>>23),C=k+(y^E&(b^y))+S[7]+1735328473&4294967295,k=b+(C<<14&4294967295|C>>>18),C=E+(b^y&(k^b))+S[12]+2368359562&4294967295,E=k+(C<<20&4294967295|C>>>12),C=y+(E^k^b)+S[5]+4294588738&4294967295,y=E+(C<<4&4294967295|C>>>28),C=b+(y^E^k)+S[8]+2272392833&4294967295,b=y+(C<<11&4294967295|C>>>21),C=k+(b^y^E)+S[11]+1839030562&4294967295,k=b+(C<<16&4294967295|C>>>16),C=E+(k^b^y)+S[14]+4259657740&4294967295,E=k+(C<<23&4294967295|C>>>9),C=y+(E^k^b)+S[1]+2763975236&4294967295,y=E+(C<<4&4294967295|C>>>28),C=b+(y^E^k)+S[4]+1272893353&4294967295,b=y+(C<<11&4294967295|C>>>21),C=k+(b^y^E)+S[7]+4139469664&4294967295,k=b+(C<<16&4294967295|C>>>16),C=E+(k^b^y)+S[10]+3200236656&4294967295,E=k+(C<<23&4294967295|C>>>9),C=y+(E^k^b)+S[13]+681279174&4294967295,y=E+(C<<4&4294967295|C>>>28),C=b+(y^E^k)+S[0]+3936430074&4294967295,b=y+(C<<11&4294967295|C>>>21),C=k+(b^y^E)+S[3]+3572445317&4294967295,k=b+(C<<16&4294967295|C>>>16),C=E+(k^b^y)+S[6]+76029189&4294967295,E=k+(C<<23&4294967295|C>>>9),C=y+(E^k^b)+S[9]+3654602809&4294967295,y=E+(C<<4&4294967295|C>>>28),C=b+(y^E^k)+S[12]+3873151461&4294967295,b=y+(C<<11&4294967295|C>>>21),C=k+(b^y^E)+S[15]+530742520&4294967295,k=b+(C<<16&4294967295|C>>>16),C=E+(k^b^y)+S[2]+3299628645&4294967295,E=k+(C<<23&4294967295|C>>>9),C=y+(k^(E|~b))+S[0]+4096336452&4294967295,y=E+(C<<6&4294967295|C>>>26),C=b+(E^(y|~k))+S[7]+1126891415&4294967295,b=y+(C<<10&4294967295|C>>>22),C=k+(y^(b|~E))+S[14]+2878612391&4294967295,k=b+(C<<15&4294967295|C>>>17),C=E+(b^(k|~y))+S[5]+4237533241&4294967295,E=k+(C<<21&4294967295|C>>>11),C=y+(k^(E|~b))+S[12]+1700485571&4294967295,y=E+(C<<6&4294967295|C>>>26),C=b+(E^(y|~k))+S[3]+2399980690&4294967295,b=y+(C<<10&4294967295|C>>>22),C=k+(y^(b|~E))+S[10]+4293915773&4294967295,k=b+(C<<15&4294967295|C>>>17),C=E+(b^(k|~y))+S[1]+2240044497&4294967295,E=k+(C<<21&4294967295|C>>>11),C=y+(k^(E|~b))+S[8]+1873313359&4294967295,y=E+(C<<6&4294967295|C>>>26),C=b+(E^(y|~k))+S[15]+4264355552&4294967295,b=y+(C<<10&4294967295|C>>>22),C=k+(y^(b|~E))+S[6]+2734768916&4294967295,k=b+(C<<15&4294967295|C>>>17),C=E+(b^(k|~y))+S[13]+1309151649&4294967295,E=k+(C<<21&4294967295|C>>>11),C=y+(k^(E|~b))+S[4]+4149444226&4294967295,y=E+(C<<6&4294967295|C>>>26),C=b+(E^(y|~k))+S[11]+3174756917&4294967295,b=y+(C<<10&4294967295|C>>>22),C=k+(y^(b|~E))+S[2]+718787259&4294967295,k=b+(C<<15&4294967295|C>>>17),C=E+(b^(k|~y))+S[9]+3951481745&4294967295,A.g[0]=A.g[0]+y&4294967295,A.g[1]=A.g[1]+(k+(C<<21&4294967295|C>>>11))&4294967295,A.g[2]=A.g[2]+k&4294967295,A.g[3]=A.g[3]+b&4294967295}r.prototype.u=function(A,y){y===void 0&&(y=A.length);for(var E=y-this.blockSize,S=this.B,k=this.h,b=0;b<y;){if(k==0)for(;b<=E;)i(this,A,b),b+=this.blockSize;if(typeof A=="string"){for(;b<y;)if(S[k++]=A.charCodeAt(b++),k==this.blockSize){i(this,S),k=0;break}}else for(;b<y;)if(S[k++]=A[b++],k==this.blockSize){i(this,S),k=0;break}}this.h=k,this.o+=y},r.prototype.v=function(){var A=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);A[0]=128;for(var y=1;y<A.length-8;++y)A[y]=0;var E=8*this.o;for(y=A.length-8;y<A.length;++y)A[y]=E&255,E/=256;for(this.u(A),A=Array(16),y=E=0;4>y;++y)for(var S=0;32>S;S+=8)A[E++]=this.g[y]>>>S&255;return A};function s(A,y){var E=a;return Object.prototype.hasOwnProperty.call(E,A)?E[A]:E[A]=y(A)}function o(A,y){this.h=y;for(var E=[],S=!0,k=A.length-1;0<=k;k--){var b=A[k]|0;S&&b==y||(E[k]=b,S=!1)}this.g=E}var a={};function u(A){return-128<=A&&128>A?s(A,function(y){return new o([y|0],0>y?-1:0)}):new o([A|0],0>A?-1:0)}function c(A){if(isNaN(A)||!isFinite(A))return f;if(0>A)return R(c(-A));for(var y=[],E=1,S=0;A>=E;S++)y[S]=A/E|0,E*=4294967296;return new o(y,0)}function d(A,y){if(A.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(A.charAt(0)=="-")return R(d(A.substring(1),y));if(0<=A.indexOf("-"))throw Error('number format error: interior "-" character');for(var E=c(Math.pow(y,8)),S=f,k=0;k<A.length;k+=8){var b=Math.min(8,A.length-k),C=parseInt(A.substring(k,k+b),y);8>b?(b=c(Math.pow(y,b)),S=S.j(b).add(c(C))):(S=S.j(E),S=S.add(c(C)))}return S}var f=u(0),p=u(1),g=u(16777216);t=o.prototype,t.m=function(){if(P(this))return-R(this).m();for(var A=0,y=1,E=0;E<this.g.length;E++){var S=this.i(E);A+=(0<=S?S:4294967296+S)*y,y*=4294967296}return A},t.toString=function(A){if(A=A||10,2>A||36<A)throw Error("radix out of range: "+A);if(T(this))return"0";if(P(this))return"-"+R(this).toString(A);for(var y=c(Math.pow(A,6)),E=this,S="";;){var k=V(E,y).g;E=x(E,k.j(y));var b=((0<E.g.length?E.g[0]:E.h)>>>0).toString(A);if(E=k,T(E))return b+S;for(;6>b.length;)b="0"+b;S=b+S}},t.i=function(A){return 0>A?0:A<this.g.length?this.g[A]:this.h};function T(A){if(A.h!=0)return!1;for(var y=0;y<A.g.length;y++)if(A.g[y]!=0)return!1;return!0}function P(A){return A.h==-1}t.l=function(A){return A=x(this,A),P(A)?-1:T(A)?0:1};function R(A){for(var y=A.g.length,E=[],S=0;S<y;S++)E[S]=~A.g[S];return new o(E,~A.h).add(p)}t.abs=function(){return P(this)?R(this):this},t.add=function(A){for(var y=Math.max(this.g.length,A.g.length),E=[],S=0,k=0;k<=y;k++){var b=S+(this.i(k)&65535)+(A.i(k)&65535),C=(b>>>16)+(this.i(k)>>>16)+(A.i(k)>>>16);S=C>>>16,b&=65535,C&=65535,E[k]=C<<16|b}return new o(E,E[E.length-1]&-2147483648?-1:0)};function x(A,y){return A.add(R(y))}t.j=function(A){if(T(this)||T(A))return f;if(P(this))return P(A)?R(this).j(R(A)):R(R(this).j(A));if(P(A))return R(this.j(R(A)));if(0>this.l(g)&&0>A.l(g))return c(this.m()*A.m());for(var y=this.g.length+A.g.length,E=[],S=0;S<2*y;S++)E[S]=0;for(S=0;S<this.g.length;S++)for(var k=0;k<A.g.length;k++){var b=this.i(S)>>>16,C=this.i(S)&65535,re=A.i(k)>>>16,Te=A.i(k)&65535;E[2*S+2*k]+=C*Te,w(E,2*S+2*k),E[2*S+2*k+1]+=b*Te,w(E,2*S+2*k+1),E[2*S+2*k+1]+=C*re,w(E,2*S+2*k+1),E[2*S+2*k+2]+=b*re,w(E,2*S+2*k+2)}for(S=0;S<y;S++)E[S]=E[2*S+1]<<16|E[2*S];for(S=y;S<2*y;S++)E[S]=0;return new o(E,0)};function w(A,y){for(;(A[y]&65535)!=A[y];)A[y+1]+=A[y]>>>16,A[y]&=65535,y++}function I(A,y){this.g=A,this.h=y}function V(A,y){if(T(y))throw Error("division by zero");if(T(A))return new I(f,f);if(P(A))return y=V(R(A),y),new I(R(y.g),R(y.h));if(P(y))return y=V(A,R(y)),new I(R(y.g),y.h);if(30<A.g.length){if(P(A)||P(y))throw Error("slowDivide_ only works with positive integers.");for(var E=p,S=y;0>=S.l(A);)E=M(E),S=M(S);var k=O(E,1),b=O(S,1);for(S=O(S,2),E=O(E,2);!T(S);){var C=b.add(S);0>=C.l(A)&&(k=k.add(E),b=C),S=O(S,1),E=O(E,1)}return y=x(A,k.j(y)),new I(k,y)}for(k=f;0<=A.l(y);){for(E=Math.max(1,Math.floor(A.m()/y.m())),S=Math.ceil(Math.log(E)/Math.LN2),S=48>=S?1:Math.pow(2,S-48),b=c(E),C=b.j(y);P(C)||0<C.l(A);)E-=S,b=c(E),C=b.j(y);T(b)&&(b=p),k=k.add(b),A=x(A,C)}return new I(k,A)}t.A=function(A){return V(this,A).h},t.and=function(A){for(var y=Math.max(this.g.length,A.g.length),E=[],S=0;S<y;S++)E[S]=this.i(S)&A.i(S);return new o(E,this.h&A.h)},t.or=function(A){for(var y=Math.max(this.g.length,A.g.length),E=[],S=0;S<y;S++)E[S]=this.i(S)|A.i(S);return new o(E,this.h|A.h)},t.xor=function(A){for(var y=Math.max(this.g.length,A.g.length),E=[],S=0;S<y;S++)E[S]=this.i(S)^A.i(S);return new o(E,this.h^A.h)};function M(A){for(var y=A.g.length+1,E=[],S=0;S<y;S++)E[S]=A.i(S)<<1|A.i(S-1)>>>31;return new o(E,A.h)}function O(A,y){var E=y>>5;y%=32;for(var S=A.g.length-E,k=[],b=0;b<S;b++)k[b]=0<y?A.i(b+E)>>>y|A.i(b+E+1)<<32-y:A.i(b+E);return new o(k,A.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,iE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=d,hi=o}).apply(typeof Jv<"u"?Jv:typeof self<"u"?self:typeof window<"u"?window:{});var pl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var sE,mo,oE,jl,sf,aE,lE,uE;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,h,m){return l==Array.prototype||l==Object.prototype||(l[h]=m.value),l};function n(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof pl=="object"&&pl];for(var h=0;h<l.length;++h){var m=l[h];if(m&&m.Math==Math)return m}throw Error("Cannot find global object")}var r=n(this);function i(l,h){if(h)e:{var m=r;l=l.split(".");for(var _=0;_<l.length-1;_++){var D=l[_];if(!(D in m))break e;m=m[D]}l=l[l.length-1],_=m[l],h=h(_),h!=_&&h!=null&&e(m,l,{configurable:!0,writable:!0,value:h})}}function s(l,h){l instanceof String&&(l+="");var m=0,_=!1,D={next:function(){if(!_&&m<l.length){var N=m++;return{value:h(N,l[N]),done:!1}}return _=!0,{done:!0,value:void 0}}};return D[Symbol.iterator]=function(){return D},D}i("Array.prototype.values",function(l){return l||function(){return s(this,function(h,m){return m})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function u(l){var h=typeof l;return h=h!="object"?h:l?Array.isArray(l)?"array":h:"null",h=="array"||h=="object"&&typeof l.length=="number"}function c(l){var h=typeof l;return h=="object"&&l!=null||h=="function"}function d(l,h,m){return l.call.apply(l.bind,arguments)}function f(l,h,m){if(!l)throw Error();if(2<arguments.length){var _=Array.prototype.slice.call(arguments,2);return function(){var D=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(D,_),l.apply(h,D)}}return function(){return l.apply(h,arguments)}}function p(l,h,m){return p=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?d:f,p.apply(null,arguments)}function g(l,h){var m=Array.prototype.slice.call(arguments,1);return function(){var _=m.slice();return _.push.apply(_,arguments),l.apply(this,_)}}function T(l,h){function m(){}m.prototype=h.prototype,l.aa=h.prototype,l.prototype=new m,l.prototype.constructor=l,l.Qb=function(_,D,N){for(var $=Array(arguments.length-2),pe=2;pe<arguments.length;pe++)$[pe-2]=arguments[pe];return h.prototype[D].apply(_,$)}}function P(l){const h=l.length;if(0<h){const m=Array(h);for(let _=0;_<h;_++)m[_]=l[_];return m}return[]}function R(l,h){for(let m=1;m<arguments.length;m++){const _=arguments[m];if(u(_)){const D=l.length||0,N=_.length||0;l.length=D+N;for(let $=0;$<N;$++)l[D+$]=_[$]}else l.push(_)}}class x{constructor(h,m){this.i=h,this.j=m,this.h=0,this.g=null}get(){let h;return 0<this.h?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function w(l){return/^[\s\xa0]*$/.test(l)}function I(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function V(l){return V[" "](l),l}V[" "]=function(){};var M=I().indexOf("Gecko")!=-1&&!(I().toLowerCase().indexOf("webkit")!=-1&&I().indexOf("Edge")==-1)&&!(I().indexOf("Trident")!=-1||I().indexOf("MSIE")!=-1)&&I().indexOf("Edge")==-1;function O(l,h,m){for(const _ in l)h.call(m,l[_],_,l)}function A(l,h){for(const m in l)h.call(void 0,l[m],m,l)}function y(l){const h={};for(const m in l)h[m]=l[m];return h}const E="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function S(l,h){let m,_;for(let D=1;D<arguments.length;D++){_=arguments[D];for(m in _)l[m]=_[m];for(let N=0;N<E.length;N++)m=E[N],Object.prototype.hasOwnProperty.call(_,m)&&(l[m]=_[m])}}function k(l){var h=1;l=l.split(":");const m=[];for(;0<h&&l.length;)m.push(l.shift()),h--;return l.length&&m.push(l.join(":")),m}function b(l){a.setTimeout(()=>{throw l},0)}function C(){var l=H;let h=null;return l.g&&(h=l.g,l.g=l.g.next,l.g||(l.h=null),h.next=null),h}class re{constructor(){this.h=this.g=null}add(h,m){const _=Te.get();_.set(h,m),this.h?this.h.next=_:this.g=_,this.h=_}}var Te=new x(()=>new Ee,l=>l.reset());class Ee{constructor(){this.next=this.g=this.h=null}set(h,m){this.h=h,this.g=m,this.next=null}reset(){this.next=this.g=this.h=null}}let ot,B=!1,H=new re,Y=()=>{const l=a.Promise.resolve(void 0);ot=()=>{l.then(ie)}};var ie=()=>{for(var l;l=C();){try{l.h.call(l.g)}catch(m){b(m)}var h=Te;h.j(l),100>h.h&&(h.h++,l.next=h.g,h.g=l)}B=!1};function le(){this.s=this.s,this.C=this.C}le.prototype.s=!1,le.prototype.ma=function(){this.s||(this.s=!0,this.N())},le.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ge(l,h){this.type=l,this.g=this.target=h,this.defaultPrevented=!1}ge.prototype.h=function(){this.defaultPrevented=!0};var Et=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,h=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const m=()=>{};a.addEventListener("test",m,h),a.removeEventListener("test",m,h)}catch{}return l}();function gt(l,h){if(ge.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var m=this.type=l.type,_=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=h,h=l.relatedTarget){if(M){e:{try{V(h.nodeName);var D=!0;break e}catch{}D=!1}D||(h=null)}}else m=="mouseover"?h=l.fromElement:m=="mouseout"&&(h=l.toElement);this.relatedTarget=h,_?(this.clientX=_.clientX!==void 0?_.clientX:_.pageX,this.clientY=_.clientY!==void 0?_.clientY:_.pageY,this.screenX=_.screenX||0,this.screenY=_.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:Vt[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&gt.aa.h.call(this)}}T(gt,ge);var Vt={2:"touch",3:"pen",4:"mouse"};gt.prototype.h=function(){gt.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var Wt="closure_listenable_"+(1e6*Math.random()|0),Ca=0;function Pa(l,h,m,_,D){this.listener=l,this.proxy=null,this.src=h,this.type=m,this.capture=!!_,this.ha=D,this.key=++Ca,this.da=this.fa=!1}function gn(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function yn(l){this.src=l,this.g={},this.h=0}yn.prototype.add=function(l,h,m,_,D){var N=l.toString();l=this.g[N],l||(l=this.g[N]=[],this.h++);var $=zr(l,h,_,D);return-1<$?(h=l[$],m||(h.fa=!1)):(h=new Pa(h,this.src,N,!!_,D),h.fa=m,l.push(h)),h};function Jn(l,h){var m=h.type;if(m in l.g){var _=l.g[m],D=Array.prototype.indexOf.call(_,h,void 0),N;(N=0<=D)&&Array.prototype.splice.call(_,D,1),N&&(gn(h),l.g[m].length==0&&(delete l.g[m],l.h--))}}function zr(l,h,m,_){for(var D=0;D<l.length;++D){var N=l[D];if(!N.da&&N.listener==h&&N.capture==!!m&&N.ha==_)return D}return-1}var Vs="closure_lm_"+(1e6*Math.random()|0),Ds={};function Ns(l,h,m,_,D){if(Array.isArray(h)){for(var N=0;N<h.length;N++)Ns(l,h[N],m,_,D);return null}return m=ka(m),l&&l[Wt]?l.K(h,m,c(_)?!!_.capture:!1,D):Tc(l,h,m,!1,_,D)}function Tc(l,h,m,_,D,N){if(!h)throw Error("Invalid event type");var $=c(D)?!!D.capture:!!D,pe=js(l);if(pe||(l[Vs]=pe=new yn(l)),m=pe.add(h,m,_,$,N),m.proxy)return m;if(_=Ec(),m.proxy=_,_.src=l,_.listener=m,l.addEventListener)Et||(D=$),D===void 0&&(D=!1),l.addEventListener(h.toString(),_,D);else if(l.attachEvent)l.attachEvent(Ls(h.toString()),_);else if(l.addListener&&l.removeListener)l.addListener(_);else throw Error("addEventListener and attachEvent are unavailable.");return m}function Ec(){function l(m){return h.call(l.src,l.listener,m)}const h=Os;return l}function Ms(l,h,m,_,D){if(Array.isArray(h))for(var N=0;N<h.length;N++)Ms(l,h[N],m,_,D);else _=c(_)?!!_.capture:!!_,m=ka(m),l&&l[Wt]?(l=l.i,h=String(h).toString(),h in l.g&&(N=l.g[h],m=zr(N,m,_,D),-1<m&&(gn(N[m]),Array.prototype.splice.call(N,m,1),N.length==0&&(delete l.g[h],l.h--)))):l&&(l=js(l))&&(h=l.g[h.toString()],l=-1,h&&(l=zr(h,m,_,D)),(m=-1<l?h[l]:null)&&Zn(m))}function Zn(l){if(typeof l!="number"&&l&&!l.da){var h=l.src;if(h&&h[Wt])Jn(h.i,l);else{var m=l.type,_=l.proxy;h.removeEventListener?h.removeEventListener(m,_,l.capture):h.detachEvent?h.detachEvent(Ls(m),_):h.addListener&&h.removeListener&&h.removeListener(_),(m=js(h))?(Jn(m,l),m.h==0&&(m.src=null,h[Vs]=null)):gn(l)}}}function Ls(l){return l in Ds?Ds[l]:Ds[l]="on"+l}function Os(l,h){if(l.da)l=!0;else{h=new gt(h,this);var m=l.listener,_=l.ha||l.src;l.fa&&Zn(l),l=m.call(_,h)}return l}function js(l){return l=l[Vs],l instanceof yn?l:null}var Fs="__closure_events_fn_"+(1e9*Math.random()>>>0);function ka(l){return typeof l=="function"?l:(l[Fs]||(l[Fs]=function(h){return l.handleEvent(h)}),l[Fs])}function He(){le.call(this),this.i=new yn(this),this.M=this,this.F=null}T(He,le),He.prototype[Wt]=!0,He.prototype.removeEventListener=function(l,h,m,_){Ms(this,l,h,m,_)};function Qe(l,h){var m,_=l.F;if(_)for(m=[];_;_=_.F)m.push(_);if(l=l.M,_=h.type||h,typeof h=="string")h=new ge(h,l);else if(h instanceof ge)h.target=h.target||l;else{var D=h;h=new ge(_,l),S(h,D)}if(D=!0,m)for(var N=m.length-1;0<=N;N--){var $=h.g=m[N];D=er($,_,!0,h)&&D}if($=h.g=l,D=er($,_,!0,h)&&D,D=er($,_,!1,h)&&D,m)for(N=0;N<m.length;N++)$=h.g=m[N],D=er($,_,!1,h)&&D}He.prototype.N=function(){if(He.aa.N.call(this),this.i){var l=this.i,h;for(h in l.g){for(var m=l.g[h],_=0;_<m.length;_++)gn(m[_]);delete l.g[h],l.h--}}this.F=null},He.prototype.K=function(l,h,m,_){return this.i.add(String(l),h,!1,m,_)},He.prototype.L=function(l,h,m,_){return this.i.add(String(l),h,!0,m,_)};function er(l,h,m,_){if(h=l.i.g[String(h)],!h)return!0;h=h.concat();for(var D=!0,N=0;N<h.length;++N){var $=h[N];if($&&!$.da&&$.capture==m){var pe=$.listener,Ye=$.ha||$.src;$.fa&&Jn(l.i,$),D=pe.call(Ye,_)!==!1&&D}}return D&&!_.defaultPrevented}function Vn(l,h,m){if(typeof l=="function")m&&(l=p(l,m));else if(l&&typeof l.handleEvent=="function")l=p(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(h)?-1:a.setTimeout(l,h||0)}function Ur(l){l.g=Vn(()=>{l.g=null,l.i&&(l.i=!1,Ur(l))},l.l);const h=l.h;l.h=null,l.m.apply(null,h)}class Bs extends le{constructor(h,m){super(),this.m=h,this.l=m,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:Ur(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function $r(l){le.call(this),this.h=l,this.g={}}T($r,le);var Ra=[];function ba(l){O(l.g,function(h,m){this.g.hasOwnProperty(m)&&Zn(h)},l),l.g={}}$r.prototype.N=function(){$r.aa.N.call(this),ba(this)},$r.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ci=a.JSON.stringify,L=a.JSON.parse,G=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function he(){}he.prototype.h=null;function Fe(l){return l.h||(l.h=l.i())}function St(){}var en={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Dn(){ge.call(this,"d")}T(Dn,ge);function Wr(){ge.call(this,"c")}T(Wr,ge);var Ht={},Nn=null;function Hr(){return Nn=Nn||new He}Ht.La="serverreachability";function Mn(l){ge.call(this,Ht.La,l)}T(Mn,ge);function tn(l){const h=Hr();Qe(h,new Mn(h))}Ht.STAT_EVENT="statevent";function Pi(l,h){ge.call(this,Ht.STAT_EVENT,l),this.stat=h}T(Pi,ge);function Ae(l){const h=Hr();Qe(h,new Pi(h,l))}Ht.Ma="timingevent";function Rm(l,h){ge.call(this,Ht.Ma,l),this.size=h}T(Rm,ge);function zs(l,h){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},h)}function Us(){this.g=!0}Us.prototype.xa=function(){this.g=!1};function W1(l,h,m,_,D,N){l.info(function(){if(l.g)if(N)for(var $="",pe=N.split("&"),Ye=0;Ye<pe.length;Ye++){var ue=pe[Ye].split("=");if(1<ue.length){var at=ue[0];ue=ue[1];var lt=at.split("_");$=2<=lt.length&&lt[1]=="type"?$+(at+"="+ue+"&"):$+(at+"=redacted&")}}else $=null;else $=N;return"XMLHTTP REQ ("+_+") [attempt "+D+"]: "+h+`
`+m+`
`+$})}function H1(l,h,m,_,D,N,$){l.info(function(){return"XMLHTTP RESP ("+_+") [ attempt "+D+"]: "+h+`
`+m+`
`+N+" "+$})}function ki(l,h,m,_){l.info(function(){return"XMLHTTP TEXT ("+h+"): "+q1(l,m)+(_?" "+_:"")})}function K1(l,h){l.info(function(){return"TIMEOUT: "+h})}Us.prototype.info=function(){};function q1(l,h){if(!l.g)return h;if(!h)return null;try{var m=JSON.parse(h);if(m){for(l=0;l<m.length;l++)if(Array.isArray(m[l])){var _=m[l];if(!(2>_.length)){var D=_[1];if(Array.isArray(D)&&!(1>D.length)){var N=D[0];if(N!="noop"&&N!="stop"&&N!="close")for(var $=1;$<D.length;$++)D[$]=""}}}}return Ci(m)}catch{return h}}var Va={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},bm={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Sc;function Da(){}T(Da,he),Da.prototype.g=function(){return new XMLHttpRequest},Da.prototype.i=function(){return{}},Sc=new Da;function tr(l,h,m,_){this.j=l,this.i=h,this.l=m,this.R=_||1,this.U=new $r(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Vm}function Vm(){this.i=null,this.g="",this.h=!1}var Dm={},Ic={};function Ac(l,h,m){l.L=1,l.v=Oa(Ln(h)),l.m=m,l.P=!0,Nm(l,null)}function Nm(l,h){l.F=Date.now(),Na(l),l.A=Ln(l.v);var m=l.A,_=l.R;Array.isArray(_)||(_=[String(_)]),Gm(m.i,"t",_),l.C=0,m=l.j.J,l.h=new Vm,l.g=dg(l.j,m?h:null,!l.m),0<l.O&&(l.M=new Bs(p(l.Y,l,l.g),l.O)),h=l.U,m=l.g,_=l.ca;var D="readystatechange";Array.isArray(D)||(D&&(Ra[0]=D.toString()),D=Ra);for(var N=0;N<D.length;N++){var $=Ns(m,D[N],_||h.handleEvent,!1,h.h||h);if(!$)break;h.g[$.key]=$}h=l.H?y(l.H):{},l.m?(l.u||(l.u="POST"),h["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,h)):(l.u="GET",l.g.ea(l.A,l.u,null,h)),tn(),W1(l.i,l.u,l.A,l.l,l.R,l.m)}tr.prototype.ca=function(l){l=l.target;const h=this.M;h&&On(l)==3?h.j():this.Y(l)},tr.prototype.Y=function(l){try{if(l==this.g)e:{const lt=On(this.g);var h=this.g.Ba();const Vi=this.g.Z();if(!(3>lt)&&(lt!=3||this.g&&(this.h.h||this.g.oa()||tg(this.g)))){this.J||lt!=4||h==7||(h==8||0>=Vi?tn(3):tn(2)),Cc(this);var m=this.g.Z();this.X=m;t:if(Mm(this)){var _=tg(this.g);l="";var D=_.length,N=On(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Kr(this),$s(this);var $="";break t}this.h.i=new a.TextDecoder}for(h=0;h<D;h++)this.h.h=!0,l+=this.h.i.decode(_[h],{stream:!(N&&h==D-1)});_.length=0,this.h.g+=l,this.C=0,$=this.h.g}else $=this.g.oa();if(this.o=m==200,H1(this.i,this.u,this.A,this.l,this.R,lt,m),this.o){if(this.T&&!this.K){t:{if(this.g){var pe,Ye=this.g;if((pe=Ye.g?Ye.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!w(pe)){var ue=pe;break t}}ue=null}if(m=ue)ki(this.i,this.l,m,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Pc(this,m);else{this.o=!1,this.s=3,Ae(12),Kr(this),$s(this);break e}}if(this.P){m=!0;let nn;for(;!this.J&&this.C<$.length;)if(nn=G1(this,$),nn==Ic){lt==4&&(this.s=4,Ae(14),m=!1),ki(this.i,this.l,null,"[Incomplete Response]");break}else if(nn==Dm){this.s=4,Ae(15),ki(this.i,this.l,$,"[Invalid Chunk]"),m=!1;break}else ki(this.i,this.l,nn,null),Pc(this,nn);if(Mm(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),lt!=4||$.length!=0||this.h.h||(this.s=1,Ae(16),m=!1),this.o=this.o&&m,!m)ki(this.i,this.l,$,"[Invalid Chunked Response]"),Kr(this),$s(this);else if(0<$.length&&!this.W){this.W=!0;var at=this.j;at.g==this&&at.ba&&!at.M&&(at.j.info("Great, no buffering proxy detected. Bytes received: "+$.length),Nc(at),at.M=!0,Ae(11))}}else ki(this.i,this.l,$,null),Pc(this,$);lt==4&&Kr(this),this.o&&!this.J&&(lt==4?lg(this.j,this):(this.o=!1,Na(this)))}else hS(this.g),m==400&&0<$.indexOf("Unknown SID")?(this.s=3,Ae(12)):(this.s=0,Ae(13)),Kr(this),$s(this)}}}catch{}finally{}};function Mm(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function G1(l,h){var m=l.C,_=h.indexOf(`
`,m);return _==-1?Ic:(m=Number(h.substring(m,_)),isNaN(m)?Dm:(_+=1,_+m>h.length?Ic:(h=h.slice(_,_+m),l.C=_+m,h)))}tr.prototype.cancel=function(){this.J=!0,Kr(this)};function Na(l){l.S=Date.now()+l.I,Lm(l,l.I)}function Lm(l,h){if(l.B!=null)throw Error("WatchDog timer not null");l.B=zs(p(l.ba,l),h)}function Cc(l){l.B&&(a.clearTimeout(l.B),l.B=null)}tr.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(K1(this.i,this.A),this.L!=2&&(tn(),Ae(17)),Kr(this),this.s=2,$s(this)):Lm(this,this.S-l)};function $s(l){l.j.G==0||l.J||lg(l.j,l)}function Kr(l){Cc(l);var h=l.M;h&&typeof h.ma=="function"&&h.ma(),l.M=null,ba(l.U),l.g&&(h=l.g,l.g=null,h.abort(),h.ma())}function Pc(l,h){try{var m=l.j;if(m.G!=0&&(m.g==l||kc(m.h,l))){if(!l.K&&kc(m.h,l)&&m.G==3){try{var _=m.Da.g.parse(h)}catch{_=null}if(Array.isArray(_)&&_.length==3){var D=_;if(D[0]==0){e:if(!m.u){if(m.g)if(m.g.F+3e3<l.F)$a(m),za(m);else break e;Dc(m),Ae(18)}}else m.za=D[1],0<m.za-m.T&&37500>D[2]&&m.F&&m.v==0&&!m.C&&(m.C=zs(p(m.Za,m),6e3));if(1>=Fm(m.h)&&m.ca){try{m.ca()}catch{}m.ca=void 0}}else Gr(m,11)}else if((l.K||m.g==l)&&$a(m),!w(h))for(D=m.Da.g.parse(h),h=0;h<D.length;h++){let ue=D[h];if(m.T=ue[0],ue=ue[1],m.G==2)if(ue[0]=="c"){m.K=ue[1],m.ia=ue[2];const at=ue[3];at!=null&&(m.la=at,m.j.info("VER="+m.la));const lt=ue[4];lt!=null&&(m.Aa=lt,m.j.info("SVER="+m.Aa));const Vi=ue[5];Vi!=null&&typeof Vi=="number"&&0<Vi&&(_=1.5*Vi,m.L=_,m.j.info("backChannelRequestTimeoutMs_="+_)),_=m;const nn=l.g;if(nn){const Ha=nn.g?nn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Ha){var N=_.h;N.g||Ha.indexOf("spdy")==-1&&Ha.indexOf("quic")==-1&&Ha.indexOf("h2")==-1||(N.j=N.l,N.g=new Set,N.h&&(Rc(N,N.h),N.h=null))}if(_.D){const Mc=nn.g?nn.g.getResponseHeader("X-HTTP-Session-Id"):null;Mc&&(_.ya=Mc,ve(_.I,_.D,Mc))}}m.G=3,m.l&&m.l.ua(),m.ba&&(m.R=Date.now()-l.F,m.j.info("Handshake RTT: "+m.R+"ms")),_=m;var $=l;if(_.qa=hg(_,_.J?_.ia:null,_.W),$.K){Bm(_.h,$);var pe=$,Ye=_.L;Ye&&(pe.I=Ye),pe.B&&(Cc(pe),Na(pe)),_.g=$}else og(_);0<m.i.length&&Ua(m)}else ue[0]!="stop"&&ue[0]!="close"||Gr(m,7);else m.G==3&&(ue[0]=="stop"||ue[0]=="close"?ue[0]=="stop"?Gr(m,7):Vc(m):ue[0]!="noop"&&m.l&&m.l.ta(ue),m.v=0)}}tn(4)}catch{}}var Q1=class{constructor(l,h){this.g=l,this.map=h}};function Om(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function jm(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function Fm(l){return l.h?1:l.g?l.g.size:0}function kc(l,h){return l.h?l.h==h:l.g?l.g.has(h):!1}function Rc(l,h){l.g?l.g.add(h):l.h=h}function Bm(l,h){l.h&&l.h==h?l.h=null:l.g&&l.g.has(h)&&l.g.delete(h)}Om.prototype.cancel=function(){if(this.i=zm(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function zm(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let h=l.i;for(const m of l.g.values())h=h.concat(m.D);return h}return P(l.i)}function Y1(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(u(l)){for(var h=[],m=l.length,_=0;_<m;_++)h.push(l[_]);return h}h=[],m=0;for(_ in l)h[m++]=l[_];return h}function X1(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(u(l)||typeof l=="string"){var h=[];l=l.length;for(var m=0;m<l;m++)h.push(m);return h}h=[],m=0;for(const _ in l)h[m++]=_;return h}}}function Um(l,h){if(l.forEach&&typeof l.forEach=="function")l.forEach(h,void 0);else if(u(l)||typeof l=="string")Array.prototype.forEach.call(l,h,void 0);else for(var m=X1(l),_=Y1(l),D=_.length,N=0;N<D;N++)h.call(void 0,_[N],m&&m[N],l)}var $m=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function J1(l,h){if(l){l=l.split("&");for(var m=0;m<l.length;m++){var _=l[m].indexOf("="),D=null;if(0<=_){var N=l[m].substring(0,_);D=l[m].substring(_+1)}else N=l[m];h(N,D?decodeURIComponent(D.replace(/\+/g," ")):"")}}}function qr(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof qr){this.h=l.h,Ma(this,l.j),this.o=l.o,this.g=l.g,La(this,l.s),this.l=l.l;var h=l.i,m=new Ks;m.i=h.i,h.g&&(m.g=new Map(h.g),m.h=h.h),Wm(this,m),this.m=l.m}else l&&(h=String(l).match($m))?(this.h=!1,Ma(this,h[1]||"",!0),this.o=Ws(h[2]||""),this.g=Ws(h[3]||"",!0),La(this,h[4]),this.l=Ws(h[5]||"",!0),Wm(this,h[6]||"",!0),this.m=Ws(h[7]||"")):(this.h=!1,this.i=new Ks(null,this.h))}qr.prototype.toString=function(){var l=[],h=this.j;h&&l.push(Hs(h,Hm,!0),":");var m=this.g;return(m||h=="file")&&(l.push("//"),(h=this.o)&&l.push(Hs(h,Hm,!0),"@"),l.push(encodeURIComponent(String(m)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),m=this.s,m!=null&&l.push(":",String(m))),(m=this.l)&&(this.g&&m.charAt(0)!="/"&&l.push("/"),l.push(Hs(m,m.charAt(0)=="/"?tS:eS,!0))),(m=this.i.toString())&&l.push("?",m),(m=this.m)&&l.push("#",Hs(m,rS)),l.join("")};function Ln(l){return new qr(l)}function Ma(l,h,m){l.j=m?Ws(h,!0):h,l.j&&(l.j=l.j.replace(/:$/,""))}function La(l,h){if(h){if(h=Number(h),isNaN(h)||0>h)throw Error("Bad port number "+h);l.s=h}else l.s=null}function Wm(l,h,m){h instanceof Ks?(l.i=h,iS(l.i,l.h)):(m||(h=Hs(h,nS)),l.i=new Ks(h,l.h))}function ve(l,h,m){l.i.set(h,m)}function Oa(l){return ve(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function Ws(l,h){return l?h?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Hs(l,h,m){return typeof l=="string"?(l=encodeURI(l).replace(h,Z1),m&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function Z1(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var Hm=/[#\/\?@]/g,eS=/[#\?:]/g,tS=/[#\?]/g,nS=/[#\?@]/g,rS=/#/g;function Ks(l,h){this.h=this.g=null,this.i=l||null,this.j=!!h}function nr(l){l.g||(l.g=new Map,l.h=0,l.i&&J1(l.i,function(h,m){l.add(decodeURIComponent(h.replace(/\+/g," ")),m)}))}t=Ks.prototype,t.add=function(l,h){nr(this),this.i=null,l=Ri(this,l);var m=this.g.get(l);return m||this.g.set(l,m=[]),m.push(h),this.h+=1,this};function Km(l,h){nr(l),h=Ri(l,h),l.g.has(h)&&(l.i=null,l.h-=l.g.get(h).length,l.g.delete(h))}function qm(l,h){return nr(l),h=Ri(l,h),l.g.has(h)}t.forEach=function(l,h){nr(this),this.g.forEach(function(m,_){m.forEach(function(D){l.call(h,D,_,this)},this)},this)},t.na=function(){nr(this);const l=Array.from(this.g.values()),h=Array.from(this.g.keys()),m=[];for(let _=0;_<h.length;_++){const D=l[_];for(let N=0;N<D.length;N++)m.push(h[_])}return m},t.V=function(l){nr(this);let h=[];if(typeof l=="string")qm(this,l)&&(h=h.concat(this.g.get(Ri(this,l))));else{l=Array.from(this.g.values());for(let m=0;m<l.length;m++)h=h.concat(l[m])}return h},t.set=function(l,h){return nr(this),this.i=null,l=Ri(this,l),qm(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[h]),this.h+=1,this},t.get=function(l,h){return l?(l=this.V(l),0<l.length?String(l[0]):h):h};function Gm(l,h,m){Km(l,h),0<m.length&&(l.i=null,l.g.set(Ri(l,h),P(m)),l.h+=m.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],h=Array.from(this.g.keys());for(var m=0;m<h.length;m++){var _=h[m];const N=encodeURIComponent(String(_)),$=this.V(_);for(_=0;_<$.length;_++){var D=N;$[_]!==""&&(D+="="+encodeURIComponent(String($[_]))),l.push(D)}}return this.i=l.join("&")};function Ri(l,h){return h=String(h),l.j&&(h=h.toLowerCase()),h}function iS(l,h){h&&!l.j&&(nr(l),l.i=null,l.g.forEach(function(m,_){var D=_.toLowerCase();_!=D&&(Km(this,_),Gm(this,D,m))},l)),l.j=h}function sS(l,h){const m=new Us;if(a.Image){const _=new Image;_.onload=g(rr,m,"TestLoadImage: loaded",!0,h,_),_.onerror=g(rr,m,"TestLoadImage: error",!1,h,_),_.onabort=g(rr,m,"TestLoadImage: abort",!1,h,_),_.ontimeout=g(rr,m,"TestLoadImage: timeout",!1,h,_),a.setTimeout(function(){_.ontimeout&&_.ontimeout()},1e4),_.src=l}else h(!1)}function oS(l,h){const m=new Us,_=new AbortController,D=setTimeout(()=>{_.abort(),rr(m,"TestPingServer: timeout",!1,h)},1e4);fetch(l,{signal:_.signal}).then(N=>{clearTimeout(D),N.ok?rr(m,"TestPingServer: ok",!0,h):rr(m,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(D),rr(m,"TestPingServer: error",!1,h)})}function rr(l,h,m,_,D){try{D&&(D.onload=null,D.onerror=null,D.onabort=null,D.ontimeout=null),_(m)}catch{}}function aS(){this.g=new G}function lS(l,h,m){const _=m||"";try{Um(l,function(D,N){let $=D;c(D)&&($=Ci(D)),h.push(_+N+"="+encodeURIComponent($))})}catch(D){throw h.push(_+"type="+encodeURIComponent("_badmap")),D}}function ja(l){this.l=l.Ub||null,this.j=l.eb||!1}T(ja,he),ja.prototype.g=function(){return new Fa(this.l,this.j)},ja.prototype.i=function(l){return function(){return l}}({});function Fa(l,h){He.call(this),this.D=l,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}T(Fa,He),t=Fa.prototype,t.open=function(l,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=h,this.readyState=1,Gs(this)},t.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const h={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(h.body=l),(this.D||a).fetch(new Request(this.A,h)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,qs(this)),this.readyState=0},t.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,Gs(this)),this.g&&(this.readyState=3,Gs(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Qm(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function Qm(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}t.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var h=l.value?l.value:new Uint8Array(0);(h=this.v.decode(h,{stream:!l.done}))&&(this.response=this.responseText+=h)}l.done?qs(this):Gs(this),this.readyState==3&&Qm(this)}},t.Ra=function(l){this.g&&(this.response=this.responseText=l,qs(this))},t.Qa=function(l){this.g&&(this.response=l,qs(this))},t.ga=function(){this.g&&qs(this)};function qs(l){l.readyState=4,l.l=null,l.j=null,l.v=null,Gs(l)}t.setRequestHeader=function(l,h){this.u.append(l,h)},t.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],h=this.h.entries();for(var m=h.next();!m.done;)m=m.value,l.push(m[0]+": "+m[1]),m=h.next();return l.join(`\r
`)};function Gs(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(Fa.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function Ym(l){let h="";return O(l,function(m,_){h+=_,h+=":",h+=m,h+=`\r
`}),h}function bc(l,h,m){e:{for(_ in m){var _=!1;break e}_=!0}_||(m=Ym(m),typeof l=="string"?m!=null&&encodeURIComponent(String(m)):ve(l,h,m))}function be(l){He.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}T(be,He);var uS=/^https?$/i,cS=["POST","PUT"];t=be.prototype,t.Ha=function(l){this.J=l},t.ea=function(l,h,m,_){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);h=h?h.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Sc.g(),this.v=this.o?Fe(this.o):Fe(Sc),this.g.onreadystatechange=p(this.Ea,this);try{this.B=!0,this.g.open(h,String(l),!0),this.B=!1}catch(N){Xm(this,N);return}if(l=m||"",m=new Map(this.headers),_)if(Object.getPrototypeOf(_)===Object.prototype)for(var D in _)m.set(D,_[D]);else if(typeof _.keys=="function"&&typeof _.get=="function")for(const N of _.keys())m.set(N,_.get(N));else throw Error("Unknown input type for opt_headers: "+String(_));_=Array.from(m.keys()).find(N=>N.toLowerCase()=="content-type"),D=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(cS,h,void 0))||_||D||m.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[N,$]of m)this.g.setRequestHeader(N,$);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{eg(this),this.u=!0,this.g.send(l),this.u=!1}catch(N){Xm(this,N)}};function Xm(l,h){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=h,l.m=5,Jm(l),Ba(l)}function Jm(l){l.A||(l.A=!0,Qe(l,"complete"),Qe(l,"error"))}t.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,Qe(this,"complete"),Qe(this,"abort"),Ba(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ba(this,!0)),be.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?Zm(this):this.bb())},t.bb=function(){Zm(this)};function Zm(l){if(l.h&&typeof o<"u"&&(!l.v[1]||On(l)!=4||l.Z()!=2)){if(l.u&&On(l)==4)Vn(l.Ea,0,l);else if(Qe(l,"readystatechange"),On(l)==4){l.h=!1;try{const $=l.Z();e:switch($){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var m;if(!(m=h)){var _;if(_=$===0){var D=String(l.D).match($m)[1]||null;!D&&a.self&&a.self.location&&(D=a.self.location.protocol.slice(0,-1)),_=!uS.test(D?D.toLowerCase():"")}m=_}if(m)Qe(l,"complete"),Qe(l,"success");else{l.m=6;try{var N=2<On(l)?l.g.statusText:""}catch{N=""}l.l=N+" ["+l.Z()+"]",Jm(l)}}finally{Ba(l)}}}}function Ba(l,h){if(l.g){eg(l);const m=l.g,_=l.v[0]?()=>{}:null;l.g=null,l.v=null,h||Qe(l,"ready");try{m.onreadystatechange=_}catch{}}}function eg(l){l.I&&(a.clearTimeout(l.I),l.I=null)}t.isActive=function(){return!!this.g};function On(l){return l.g?l.g.readyState:0}t.Z=function(){try{return 2<On(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(l){if(this.g){var h=this.g.responseText;return l&&h.indexOf(l)==0&&(h=h.substring(l.length)),L(h)}};function tg(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function hS(l){const h={};l=(l.g&&2<=On(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let _=0;_<l.length;_++){if(w(l[_]))continue;var m=k(l[_]);const D=m[0];if(m=m[1],typeof m!="string")continue;m=m.trim();const N=h[D]||[];h[D]=N,N.push(m)}A(h,function(_){return _.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Qs(l,h,m){return m&&m.internalChannelParams&&m.internalChannelParams[l]||h}function ng(l){this.Aa=0,this.i=[],this.j=new Us,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Qs("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Qs("baseRetryDelayMs",5e3,l),this.cb=Qs("retryDelaySeedMs",1e4,l),this.Wa=Qs("forwardChannelMaxRetries",2,l),this.wa=Qs("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Om(l&&l.concurrentRequestLimit),this.Da=new aS,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=ng.prototype,t.la=8,t.G=1,t.connect=function(l,h,m,_){Ae(0),this.W=l,this.H=h||{},m&&_!==void 0&&(this.H.OSID=m,this.H.OAID=_),this.F=this.X,this.I=hg(this,null,this.W),Ua(this)};function Vc(l){if(rg(l),l.G==3){var h=l.U++,m=Ln(l.I);if(ve(m,"SID",l.K),ve(m,"RID",h),ve(m,"TYPE","terminate"),Ys(l,m),h=new tr(l,l.j,h),h.L=2,h.v=Oa(Ln(m)),m=!1,a.navigator&&a.navigator.sendBeacon)try{m=a.navigator.sendBeacon(h.v.toString(),"")}catch{}!m&&a.Image&&(new Image().src=h.v,m=!0),m||(h.g=dg(h.j,null),h.g.ea(h.v)),h.F=Date.now(),Na(h)}cg(l)}function za(l){l.g&&(Nc(l),l.g.cancel(),l.g=null)}function rg(l){za(l),l.u&&(a.clearTimeout(l.u),l.u=null),$a(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function Ua(l){if(!jm(l.h)&&!l.s){l.s=!0;var h=l.Ga;ot||Y(),B||(ot(),B=!0),H.add(h,l),l.B=0}}function dS(l,h){return Fm(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=h.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=zs(p(l.Ga,l,h),ug(l,l.B)),l.B++,!0)}t.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const D=new tr(this,this.j,l);let N=this.o;if(this.S&&(N?(N=y(N),S(N,this.S)):N=this.S),this.m!==null||this.O||(D.H=N,N=null),this.P)e:{for(var h=0,m=0;m<this.i.length;m++){t:{var _=this.i[m];if("__data__"in _.map&&(_=_.map.__data__,typeof _=="string")){_=_.length;break t}_=void 0}if(_===void 0)break;if(h+=_,4096<h){h=m;break e}if(h===4096||m===this.i.length-1){h=m+1;break e}}h=1e3}else h=1e3;h=sg(this,D,h),m=Ln(this.I),ve(m,"RID",l),ve(m,"CVER",22),this.D&&ve(m,"X-HTTP-Session-Id",this.D),Ys(this,m),N&&(this.O?h="headers="+encodeURIComponent(String(Ym(N)))+"&"+h:this.m&&bc(m,this.m,N)),Rc(this.h,D),this.Ua&&ve(m,"TYPE","init"),this.P?(ve(m,"$req",h),ve(m,"SID","null"),D.T=!0,Ac(D,m,null)):Ac(D,m,h),this.G=2}}else this.G==3&&(l?ig(this,l):this.i.length==0||jm(this.h)||ig(this))};function ig(l,h){var m;h?m=h.l:m=l.U++;const _=Ln(l.I);ve(_,"SID",l.K),ve(_,"RID",m),ve(_,"AID",l.T),Ys(l,_),l.m&&l.o&&bc(_,l.m,l.o),m=new tr(l,l.j,m,l.B+1),l.m===null&&(m.H=l.o),h&&(l.i=h.D.concat(l.i)),h=sg(l,m,1e3),m.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),Rc(l.h,m),Ac(m,_,h)}function Ys(l,h){l.H&&O(l.H,function(m,_){ve(h,_,m)}),l.l&&Um({},function(m,_){ve(h,_,m)})}function sg(l,h,m){m=Math.min(l.i.length,m);var _=l.l?p(l.l.Na,l.l,l):null;e:{var D=l.i;let N=-1;for(;;){const $=["count="+m];N==-1?0<m?(N=D[0].g,$.push("ofs="+N)):N=0:$.push("ofs="+N);let pe=!0;for(let Ye=0;Ye<m;Ye++){let ue=D[Ye].g;const at=D[Ye].map;if(ue-=N,0>ue)N=Math.max(0,D[Ye].g-100),pe=!1;else try{lS(at,$,"req"+ue+"_")}catch{_&&_(at)}}if(pe){_=$.join("&");break e}}}return l=l.i.splice(0,m),h.D=l,_}function og(l){if(!l.g&&!l.u){l.Y=1;var h=l.Fa;ot||Y(),B||(ot(),B=!0),H.add(h,l),l.v=0}}function Dc(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=zs(p(l.Fa,l),ug(l,l.v)),l.v++,!0)}t.Fa=function(){if(this.u=null,ag(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=zs(p(this.ab,this),l)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ae(10),za(this),ag(this))};function Nc(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function ag(l){l.g=new tr(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var h=Ln(l.qa);ve(h,"RID","rpc"),ve(h,"SID",l.K),ve(h,"AID",l.T),ve(h,"CI",l.F?"0":"1"),!l.F&&l.ja&&ve(h,"TO",l.ja),ve(h,"TYPE","xmlhttp"),Ys(l,h),l.m&&l.o&&bc(h,l.m,l.o),l.L&&(l.g.I=l.L);var m=l.g;l=l.ia,m.L=1,m.v=Oa(Ln(h)),m.m=null,m.P=!0,Nm(m,l)}t.Za=function(){this.C!=null&&(this.C=null,za(this),Dc(this),Ae(19))};function $a(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function lg(l,h){var m=null;if(l.g==h){$a(l),Nc(l),l.g=null;var _=2}else if(kc(l.h,h))m=h.D,Bm(l.h,h),_=1;else return;if(l.G!=0){if(h.o)if(_==1){m=h.m?h.m.length:0,h=Date.now()-h.F;var D=l.B;_=Hr(),Qe(_,new Rm(_,m)),Ua(l)}else og(l);else if(D=h.s,D==3||D==0&&0<h.X||!(_==1&&dS(l,h)||_==2&&Dc(l)))switch(m&&0<m.length&&(h=l.h,h.i=h.i.concat(m)),D){case 1:Gr(l,5);break;case 4:Gr(l,10);break;case 3:Gr(l,6);break;default:Gr(l,2)}}}function ug(l,h){let m=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(m*=2),m*h}function Gr(l,h){if(l.j.info("Error code "+h),h==2){var m=p(l.fb,l),_=l.Xa;const D=!_;_=new qr(_||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Ma(_,"https"),Oa(_),D?sS(_.toString(),m):oS(_.toString(),m)}else Ae(2);l.G=0,l.l&&l.l.sa(h),cg(l),rg(l)}t.fb=function(l){l?(this.j.info("Successfully pinged google.com"),Ae(2)):(this.j.info("Failed to ping google.com"),Ae(1))};function cg(l){if(l.G=0,l.ka=[],l.l){const h=zm(l.h);(h.length!=0||l.i.length!=0)&&(R(l.ka,h),R(l.ka,l.i),l.h.i.length=0,P(l.i),l.i.length=0),l.l.ra()}}function hg(l,h,m){var _=m instanceof qr?Ln(m):new qr(m);if(_.g!="")h&&(_.g=h+"."+_.g),La(_,_.s);else{var D=a.location;_=D.protocol,h=h?h+"."+D.hostname:D.hostname,D=+D.port;var N=new qr(null);_&&Ma(N,_),h&&(N.g=h),D&&La(N,D),m&&(N.l=m),_=N}return m=l.D,h=l.ya,m&&h&&ve(_,m,h),ve(_,"VER",l.la),Ys(l,_),_}function dg(l,h,m){if(h&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return h=l.Ca&&!l.pa?new be(new ja({eb:m})):new be(l.pa),h.Ha(l.J),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function fg(){}t=fg.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Wa(){}Wa.prototype.g=function(l,h){return new Dt(l,h)};function Dt(l,h){He.call(this),this.g=new ng(h),this.l=l,this.h=h&&h.messageUrlParams||null,l=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(l?l["X-WebChannel-Content-Type"]=h.messageContentType:l={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.va&&(l?l["X-WebChannel-Client-Profile"]=h.va:l={"X-WebChannel-Client-Profile":h.va}),this.g.S=l,(l=h&&h.Sb)&&!w(l)&&(this.g.m=l),this.v=h&&h.supportsCrossDomainXhr||!1,this.u=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!w(h)&&(this.g.D=h,l=this.h,l!==null&&h in l&&(l=this.h,h in l&&delete l[h])),this.j=new bi(this)}T(Dt,He),Dt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Dt.prototype.close=function(){Vc(this.g)},Dt.prototype.o=function(l){var h=this.g;if(typeof l=="string"){var m={};m.__data__=l,l=m}else this.u&&(m={},m.__data__=Ci(l),l=m);h.i.push(new Q1(h.Ya++,l)),h.G==3&&Ua(h)},Dt.prototype.N=function(){this.g.l=null,delete this.j,Vc(this.g),delete this.g,Dt.aa.N.call(this)};function pg(l){Dn.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var h=l.__sm__;if(h){e:{for(const m in h){l=m;break e}l=void 0}(this.i=l)&&(l=this.i,h=h!==null&&l in h?h[l]:void 0),this.data=h}else this.data=l}T(pg,Dn);function mg(){Wr.call(this),this.status=1}T(mg,Wr);function bi(l){this.g=l}T(bi,fg),bi.prototype.ua=function(){Qe(this.g,"a")},bi.prototype.ta=function(l){Qe(this.g,new pg(l))},bi.prototype.sa=function(l){Qe(this.g,new mg)},bi.prototype.ra=function(){Qe(this.g,"b")},Wa.prototype.createWebChannel=Wa.prototype.g,Dt.prototype.send=Dt.prototype.o,Dt.prototype.open=Dt.prototype.m,Dt.prototype.close=Dt.prototype.close,uE=function(){return new Wa},lE=function(){return Hr()},aE=Ht,sf={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Va.NO_ERROR=0,Va.TIMEOUT=8,Va.HTTP_ERROR=6,jl=Va,bm.COMPLETE="complete",oE=bm,St.EventType=en,en.OPEN="a",en.CLOSE="b",en.ERROR="c",en.MESSAGE="d",He.prototype.listen=He.prototype.K,mo=St,be.prototype.listenOnce=be.prototype.L,be.prototype.getLastError=be.prototype.Ka,be.prototype.getLastErrorCode=be.prototype.Ba,be.prototype.getStatus=be.prototype.Z,be.prototype.getResponseJson=be.prototype.Oa,be.prototype.getResponseText=be.prototype.oa,be.prototype.send=be.prototype.ea,be.prototype.setWithCredentials=be.prototype.Ha,sE=be}).apply(typeof pl<"u"?pl:typeof self<"u"?self:typeof window<"u"?window:{});const Zv="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qD{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.Sr=1,this.br=new rt(Ke.Er)}checkEmpty(e){return F.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,r,i){const s=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new fD(s,n,r,i);this.mutationQueue.push(o);for(const a of i)this.br=this.br.add(new Ke(a.key,s)),this.indexManager.addToCollectionParentIndex(e,a.key.path.popLast());return F.resolve(o)}lookupMutationBatch(e,n){return F.resolve(this.Dr(n))}getNextMutationBatchAfterBatchId(e,n){const r=n+1,i=this.vr(r),s=i<0?0:i;return F.resolve(this.mutationQueue.length>s?this.mutationQueue[s]:null)}getHighestUnacknowledgedBatchId(){return F.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return F.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const r=new Ke(n,0),i=new Ke(n,Number.POSITIVE_INFINITY),s=[];return this.br.forEachInRange([r,i],o=>{const a=this.Dr(o.wr);s.push(a)}),F.resolve(s)}getAllMutationBatchesAffectingDocumentKeys(e,n){let r=new rt(ce);return n.forEach(i=>{const s=new Ke(i,0),o=new Ke(i,Number.POSITIVE_INFINITY);this.br.forEachInRange([s,o],a=>{r=r.add(a.wr)})}),F.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,n){const r=n.path,i=r.length+1;let s=r;X.isDocumentKey(s)||(s=s.child(""));const o=new Ke(new X(s),0);let a=new rt(ce);return this.br.forEachWhile(u=>{const c=u.key.path;return!!r.isPrefixOf(c)&&(c.length===i&&(a=a.add(u.wr)),!0)},o),F.resolve(this.Cr(a))}Cr(e){const n=[];return e.forEach(r=>{const i=this.Dr(r);i!==null&&n.push(i)}),n}removeMutationBatch(e,n){fe(this.Fr(n.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return F.forEach(n.mutations,i=>{const s=new Ke(i.key,n.batchId);return r=r.delete(s),this.referenceDelegate.markPotentiallyOrphaned(e,i.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,n){const r=new Ke(n,0),i=this.br.firstAfterOrEqual(r);return F.resolve(n.isEqual(i&&i.key))}performConsistencyCheck(e){return this.mutationQueue.length,F.resolve()}Fr(e,n){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const n=this.vr(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eN{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return tb()?8:DV(J2())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Yi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Zi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new ZD;return this.Xi(e,n,o).next(a=>{if(s.result=a,this.zi)return this.es(e,n,o,a.size)})}).next(()=>s.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(ao()<=oe.DEBUG&&q("QueryEngine","SDK will not create cache indexes for query:",Mi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),F.resolve()):(ao()<=oe.DEBUG&&q("QueryEngine","Query:",Mi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(ao()<=oe.DEBUG&&q("QueryEngine","The SDK decides to create cache indexes for query:",Mi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Cn(n))):F.resolve())}Yi(e,n){if(u0(n))return F.resolve(null);let r=Cn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=cf(n,null,"F"),r=Cn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=ne(...s);return this.Ji.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(u=>{const c=this.ts(n,a);return this.ns(n,c,o,u.readTime)?this.Yi(e,cf(n,null,"F")):this.rs(e,c,n,u)}))})))}Zi(e,n,r,i){return u0(n)||i.isEqual(Z.min())?F.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const o=this.ts(n,s);return this.ns(n,o,r,i)?F.resolve(null):(ao()<=oe.DEBUG&&q("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Mi(n)),this.rs(e,o,n,PV(i,-1)).next(a=>a))})}ts(e,n){let r=new rt(TE(e));return n.forEach((i,s)=>{lc(e,s)&&(r=r.add(s))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,n,r){return ao()<=oe.DEBUG&&q("QueryEngine","Using full collection scan to execute query:",Mi(n)),this.Ji.getDocumentsMatchingQuery(e,n,Vr.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ht="WebChannelConnection";class fN extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+n.host,this.vo=`projects/${i}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Fo(){return!1}Mo(n,r,i,s,o){const a=kh(),u=this.xo(n,r.toUriEncodedString());q("RestConnection",`Sending RPC '${n}' ${a}:`,u,i);const c={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(c,s,o),this.No(n,u,c,i).then(d=>(q("RestConnection",`Received RPC '${n}' ${a}: `,d),d),d=>{throw ms("RestConnection",`RPC '${n}' ${a} failed with error: `,d,"url: ",u,"request:",i),d})}Lo(n,r,i,s,o,a){return this.Mo(n,r,i,s,o)}Oo(n,r,i){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+ks}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,o)=>n[o]=s),i&&i.headers.forEach((s,o)=>n[o]=s)}xo(n,r){const i=hN[n];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,n,r,i){const s=kh();return new Promise((o,a)=>{const u=new sE;u.setWithCredentials(!0),u.listenOnce(oE.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case jl.NO_ERROR:const d=u.getResponseJson();q(ht,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(d)),o(d);break;case jl.TIMEOUT:q(ht,`RPC '${e}' ${s} timed out`),a(new Q(z.DEADLINE_EXCEEDED,"Request time out"));break;case jl.HTTP_ERROR:const f=u.getStatus();if(q(ht,`RPC '${e}' ${s} failed with status:`,f,"response text:",u.getResponseText()),f>0){let p=u.getResponseJson();Array.isArray(p)&&(p=p[0]);const g=p==null?void 0:p.error;if(g&&g.status&&g.message){const T=function(R){const x=R.toLowerCase().replace(/_/g,"-");return Object.values(z).indexOf(x)>=0?x:z.UNKNOWN}(g.status);a(new Q(T,g.message))}else a(new Q(z.UNKNOWN,"Server responded with status "+u.getStatus()))}else a(new Q(z.UNAVAILABLE,"Connection failed."));break;default:J()}}finally{q(ht,`RPC '${e}' ${s} completed.`)}});const c=JSON.stringify(i);q(ht,`RPC '${e}' ${s} sending request:`,i),u.send(n,"POST",c,r,15)})}Bo(e,n,r){const i=kh(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=uE(),a=lE(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(u.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const d=s.join("");q(ht,`Creating RPC '${e}' stream ${i}: ${d}`,u);const f=o.createWebChannel(d,u);let p=!1,g=!1;const T=new dN({Io:R=>{g?q(ht,`Not sending because RPC '${e}' stream ${i} is closed:`,R):(p||(q(ht,`Opening RPC '${e}' stream ${i} transport.`),f.open(),p=!0),q(ht,`RPC '${e}' stream ${i} sending:`,R),f.send(R))},To:()=>f.close()}),P=(R,x,w)=>{R.listen(x,I=>{try{w(I)}catch(V){setTimeout(()=>{throw V},0)}})};return P(f,mo.EventType.OPEN,()=>{g||(q(ht,`RPC '${e}' stream ${i} transport opened.`),T.yo())}),P(f,mo.EventType.CLOSE,()=>{g||(g=!0,q(ht,`RPC '${e}' stream ${i} transport closed`),T.So())}),P(f,mo.EventType.ERROR,R=>{g||(g=!0,ms(ht,`RPC '${e}' stream ${i} transport errored:`,R),T.So(new Q(z.UNAVAILABLE,"The operation could not be completed")))}),P(f,mo.EventType.MESSAGE,R=>{var x;if(!g){const w=R.data[0];fe(!!w);const I=w,V=I.error||((x=I[0])===null||x===void 0?void 0:x.error);if(V){q(ht,`RPC '${e}' stream ${i} received error:`,V);const M=V.status;let O=function(E){const S=Le[E];if(S!==void 0)return DE(S)}(M),A=V.message;O===void 0&&(O=z.INTERNAL,A="Unknown error status: "+M+" with message "+V.message),g=!0,T.So(new Q(O,A)),f.close()}else q(ht,`RPC '${e}' stream ${i} received:`,w),T.bo(w)}}),P(a,aE.STAT_EVENT,R=>{R.stat===sf.PROXY?q(ht,`RPC '${e}' stream ${i} detected buffering proxy`):R.stat===sf.NOPROXY&&q(ht,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{T.wo()},0),T}}function Rh(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZE{constructor(e){this.key=e}}class e1{constructor(e){this.key=e}}class ON{constructor(e,n){this.query=e,this.Ta=n,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=ne(),this.mutatedKeys=ne(),this.Aa=TE(e),this.Ra=new ss(this.Aa)}get Va(){return this.Ta}ma(e,n){const r=n?n.fa:new S0,i=n?n.Ra:this.Ra;let s=n?n.mutatedKeys:this.mutatedKeys,o=i,a=!1;const u=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,c=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((d,f)=>{const p=i.get(d),g=lc(this.query,f)?f:null,T=!!p&&this.mutatedKeys.has(p.key),P=!!g&&(g.hasLocalMutations||this.mutatedKeys.has(g.key)&&g.hasCommittedMutations);let R=!1;p&&g?p.data.isEqual(g.data)?T!==P&&(r.track({type:3,doc:g}),R=!0):this.ga(p,g)||(r.track({type:2,doc:g}),R=!0,(u&&this.Aa(g,u)>0||c&&this.Aa(g,c)<0)&&(a=!0)):!p&&g?(r.track({type:0,doc:g}),R=!0):p&&!g&&(r.track({type:1,doc:p}),R=!0,(u||c)&&(a=!0)),R&&(g?(o=o.add(g),s=P?s.add(d):s.delete(d)):(o=o.delete(d),s=s.delete(d)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const d=this.query.limitType==="F"?o.last():o.first();o=o.delete(d.key),s=s.delete(d.key),r.track({type:1,doc:d})}return{Ra:o,fa:r,ns:a,mutatedKeys:s}}ga(e,n){return e.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(e,n,r,i){const s=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const o=e.fa.G_();o.sort((d,f)=>function(g,T){const P=R=>{switch(R){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return J()}};return P(g)-P(T)}(d.type,f.type)||this.Aa(d.doc,f.doc)),this.pa(r),i=i!=null&&i;const a=n&&!i?this.ya():[],u=this.da.size===0&&this.current&&!i?1:0,c=u!==this.Ea;return this.Ea=u,o.length!==0||c?{snapshot:new ws(this.query,e.Ra,s,o,e.mutatedKeys,u===0,c,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:a}:{wa:a}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new S0,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(n=>this.Ta=this.Ta.add(n)),e.modifiedDocuments.forEach(n=>{}),e.removedDocuments.forEach(n=>this.Ta=this.Ta.delete(n)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=ne(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const n=[];return e.forEach(r=>{this.da.has(r)||n.push(new e1(r))}),this.da.forEach(r=>{e.has(r)||n.push(new ZE(r))}),n}ba(e){this.Ta=e.Ts,this.da=ne();const n=this.ma(e.documents);return this.applyChanges(n,!0)}Da(){return ws.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class jN{constructor(e,n,r){this.query=e,this.targetId=n,this.view=r}}class FN{constructor(e){this.key=e,this.va=!1}}class BN{constructor(e,n,r,i,s,o){this.localStore=e,this.remoteStore=n,this.eventManager=r,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=o,this.Ca={},this.Fa=new Rs(a=>xE(a),ac),this.Ma=new Map,this.xa=new Set,this.Oa=new Re(X.comparator),this.Na=new Map,this.La=new om,this.Ba={},this.ka=new Map,this.qa=_s.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function zN(t,e,n=!0){const r=o1(t);let i;const s=r.Fa.get(e);return s?(r.sharedClientState.addLocalQueryTarget(s.targetId),i=s.view.Da()):i=await t1(r,e,n,!0),i}async function UN(t,e){const n=o1(t);await t1(n,e,!0,!1)}async function t1(t,e,n,r){const i=await aN(t.localStore,Cn(e)),s=i.targetId,o=t.sharedClientState.addLocalQueryTarget(s,n);let a;return r&&(a=await $N(t,e,s,o==="current",i.resumeToken)),t.isPrimaryClient&&n&&qE(t.remoteStore,i),a}async function $N(t,e,n,r,i){t.Ka=(f,p,g)=>async function(P,R,x,w){let I=R.view.ma(x);I.ns&&(I=await w0(P.localStore,R.query,!1).then(({documents:A})=>R.view.ma(A,I)));const V=w&&w.targetChanges.get(R.targetId),M=w&&w.targetMismatches.get(R.targetId)!=null,O=R.view.applyChanges(I,P.isPrimaryClient,V,M);return P0(P,R.targetId,O.wa),O.snapshot}(t,f,p,g);const s=await w0(t.localStore,e,!0),o=new ON(e,s.Ts),a=o.ma(s.documents),u=Sa.createSynthesizedTargetChangeForCurrentChange(n,r&&t.onlineState!=="Offline",i),c=o.applyChanges(a,t.isPrimaryClient,u);P0(t,n,c.wa);const d=new jN(e,n,o);return t.Fa.set(e,d),t.Ma.has(n)?t.Ma.get(n).push(e):t.Ma.set(n,[e]),c.snapshot}async function WN(t,e,n){const r=ee(t),i=r.Fa.get(e),s=r.Ma.get(i.targetId);if(s.length>1)return r.Ma.set(i.targetId,s.filter(o=>!ac(o,e))),void r.Fa.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await mf(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),n&&um(r.remoteStore,i.targetId),yf(r,i.targetId)}).catch(xa)):(yf(r,i.targetId),await mf(r.localStore,i.targetId,!0))}async function HN(t,e){const n=ee(t),r=n.Fa.get(e),i=n.Ma.get(r.targetId);n.isPrimaryClient&&i.length===1&&(n.sharedClientState.removeLocalQueryTarget(r.targetId),um(n.remoteStore,r.targetId))}async function KN(t,e,n){const r=ZN(t);try{const i=await function(o,a){const u=ee(o),c=We.now(),d=a.reduce((g,T)=>g.add(T.key),ne());let f,p;return u.persistence.runTransaction("Locally write mutations","readwrite",g=>{let T=Yn(),P=ne();return u.cs.getEntries(g,d).next(R=>{T=R,T.forEach((x,w)=>{w.isValidDocument()||(P=P.add(x))})}).next(()=>u.localDocuments.getOverlayedDocuments(g,T)).next(R=>{f=R;const x=[];for(const w of a){const I=hD(w,f.get(w.key).overlayedDocument);I!=null&&x.push(new Br(w.key,I,pE(I.value.mapValue),fn.exists(!0)))}return u.mutationQueue.addMutationBatch(g,c,x,a)}).next(R=>{p=R;const x=R.applyToLocalDocumentSet(f,P);return u.documentOverlayCache.saveOverlays(g,R.batchId,x)})}).then(()=>({batchId:p.batchId,changes:SE(f)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(i.batchId),function(o,a,u){let c=o.Ba[o.currentUser.toKey()];c||(c=new Re(ce)),c=c.insert(a,u),o.Ba[o.currentUser.toKey()]=c}(r,i.batchId,n),await Aa(r,i.changes),await pc(r.remoteStore)}catch(i){const s=pm(i,"Failed to persist write");n.reject(s)}}async function n1(t,e){const n=ee(t);try{const r=await iN(n.localStore,e);e.targetChanges.forEach((i,s)=>{const o=n.Na.get(s);o&&(fe(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1),i.addedDocuments.size>0?o.va=!0:i.modifiedDocuments.size>0?fe(o.va):i.removedDocuments.size>0&&(fe(o.va),o.va=!1))}),await Aa(n,r,e)}catch(r){await xa(r)}}function C0(t,e,n){const r=ee(t);if(r.isPrimaryClient&&n===0||!r.isPrimaryClient&&n===1){const i=[];r.Fa.forEach((s,o)=>{const a=o.view.Z_(e);a.snapshot&&i.push(a.snapshot)}),function(o,a){const u=ee(o);u.onlineState=a;let c=!1;u.queries.forEach((d,f)=>{for(const p of f.j_)p.Z_(a)&&(c=!0)}),c&&mm(u)}(r.eventManager,e),i.length&&r.Ca.d_(i),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function qN(t,e,n){const r=ee(t);r.sharedClientState.updateQueryState(e,"rejected",n);const i=r.Na.get(e),s=i&&i.key;if(s){let o=new Re(X.comparator);o=o.insert(s,pt.newNoDocument(s,Z.min()));const a=ne().add(s),u=new hc(Z.min(),new Map,new Re(ce),o,a);await n1(r,u),r.Oa=r.Oa.remove(s),r.Na.delete(e),gm(r)}else await mf(r.localStore,e,!1).then(()=>yf(r,e,n)).catch(xa)}async function GN(t,e){const n=ee(t),r=e.batch.batchId;try{const i=await rN(n.localStore,e);i1(n,r,null),r1(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await Aa(n,i)}catch(i){await xa(i)}}async function QN(t,e,n){const r=ee(t);try{const i=await function(o,a){const u=ee(o);return u.persistence.runTransaction("Reject batch","readwrite-primary",c=>{let d;return u.mutationQueue.lookupMutationBatch(c,a).next(f=>(fe(f!==null),d=f.keys(),u.mutationQueue.removeMutationBatch(c,f))).next(()=>u.mutationQueue.performConsistencyCheck(c)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(c,d,a)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(c,d)).next(()=>u.localDocuments.getDocuments(c,d))})}(r.localStore,e);i1(r,e,n),r1(r,e),r.sharedClientState.updateMutationState(e,"rejected",n),await Aa(r,i)}catch(i){await xa(i)}}function r1(t,e){(t.ka.get(e)||[]).forEach(n=>{n.resolve()}),t.ka.delete(e)}function i1(t,e,n){const r=ee(t);let i=r.Ba[r.currentUser.toKey()];if(i){const s=i.get(e);s&&(n?s.reject(n):s.resolve(),i=i.remove(e)),r.Ba[r.currentUser.toKey()]=i}}function yf(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const r of t.Ma.get(e))t.Fa.delete(r),n&&t.Ca.$a(r,n);t.Ma.delete(e),t.isPrimaryClient&&t.La.gr(e).forEach(r=>{t.La.containsKey(r)||s1(t,r)})}function s1(t,e){t.xa.delete(e.path.canonicalString());const n=t.Oa.get(e);n!==null&&(um(t.remoteStore,n),t.Oa=t.Oa.remove(e),t.Na.delete(n),gm(t))}function P0(t,e,n){for(const r of n)r instanceof ZE?(t.La.addReference(r.key,e),YN(t,r)):r instanceof e1?(q("SyncEngine","Document no longer in limbo: "+r.key),t.La.removeReference(r.key,e),t.La.containsKey(r.key)||s1(t,r.key)):J()}function YN(t,e){const n=e.key,r=n.path.canonicalString();t.Oa.get(n)||t.xa.has(r)||(q("SyncEngine","New document in limbo: "+n),t.xa.add(r),gm(t))}function gm(t){for(;t.xa.size>0&&t.Oa.size<t.maxConcurrentLimboResolutions;){const e=t.xa.values().next().value;t.xa.delete(e);const n=new X(Ie.fromString(e)),r=t.qa.next();t.Na.set(r,new FN(n)),t.Oa=t.Oa.insert(n,r),qE(t.remoteStore,new pr(Cn(em(n.path)),r,"TargetPurposeLimboResolution",Gp.oe))}}async function Aa(t,e,n){const r=ee(t),i=[],s=[],o=[];r.Fa.isEmpty()||(r.Fa.forEach((a,u)=>{o.push(r.Ka(u,e,n).then(c=>{var d;if((c||n)&&r.isPrimaryClient){const f=c?!c.fromCache:(d=n==null?void 0:n.targetChanges.get(u.targetId))===null||d===void 0?void 0:d.current;r.sharedClientState.updateQueryState(u.targetId,f?"current":"not-current")}if(c){i.push(c);const f=lm.Wi(u.targetId,c);s.push(f)}}))}),await Promise.all(o),r.Ca.d_(i),await async function(u,c){const d=ee(u);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",f=>F.forEach(c,p=>F.forEach(p.$i,g=>d.persistence.referenceDelegate.addReference(f,p.targetId,g)).next(()=>F.forEach(p.Ui,g=>d.persistence.referenceDelegate.removeReference(f,p.targetId,g)))))}catch(f){if(!Ta(f))throw f;q("LocalStore","Failed to update sequence numbers: "+f)}for(const f of c){const p=f.targetId;if(!f.fromCache){const g=d.os.get(p),T=g.snapshotVersion,P=g.withLastLimboFreeSnapshotVersion(T);d.os=d.os.insert(p,P)}}}(r.localStore,s))}async function XN(t,e){const n=ee(t);if(!n.currentUser.isEqual(e)){q("SyncEngine","User change. New user:",e.toKey());const r=await $E(n.localStore,e);n.currentUser=e,function(s,o){s.ka.forEach(a=>{a.forEach(u=>{u.reject(new Q(z.CANCELLED,o))})}),s.ka.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Aa(n,r.hs)}}function JN(t,e){const n=ee(t),r=n.Na.get(e);if(r&&r.va)return ne().add(r.key);{let i=ne();const s=n.Ma.get(e);if(!s)return i;for(const o of s){const a=n.Fa.get(o);i=i.unionWith(a.view.Va)}return i}}function o1(t){const e=ee(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=n1.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=JN.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=qN.bind(null,e),e.Ca.d_=NN.bind(null,e.eventManager),e.Ca.$a=MN.bind(null,e.eventManager),e}function ZN(t){const e=ee(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=GN.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=QN.bind(null,e),e}class Du{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=dc(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,n){return null}Ha(e,n){return null}za(e){return nN(this.persistence,new eN,e.initialUser,this.serializer)}Ga(e){return new XD(am.Zr,this.serializer)}Wa(e){return new uN}async terminate(){var e,n;(e=this.gcScheduler)===null||e===void 0||e.stop(),(n=this.indexBackfillerScheduler)===null||n===void 0||n.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Du.provider={build:()=>new Du};class vf{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>C0(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=XN.bind(null,this.syncEngine),await kN(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new bN}()}createDatastore(e){const n=dc(e.databaseInfo.databaseId),r=function(s){return new fN(s)}(e.databaseInfo);return function(s,o,a,u){return new gN(s,o,a,u)}(e.authCredentials,e.appCheckCredentials,r,n)}createRemoteStore(e){return function(r,i,s,o,a){return new vN(r,i,s,o,a)}(this.localStore,this.datastore,e.asyncQueue,n=>C0(this.syncEngine,n,0),function(){return T0.D()?new T0:new cN}())}createSyncEngine(e,n){return function(i,s,o,a,u,c,d){const f=new BN(i,s,o,a,u,c);return d&&(f.Qa=!0),f}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}async terminate(){var e,n;await async function(i){const s=ee(i);q("RemoteStore","RemoteStore shutting down."),s.L_.add(5),await Ia(s),s.k_.shutdown(),s.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(n=this.eventManager)===null||n===void 0||n.terminate()}}vf.provider={build:()=>new vf};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lM=/^__.*__$/;class uM{constructor(e,n,r){this.data=e,this.fieldMask=n,this.fieldTransforms=r}toMutation(e,n){return this.fieldMask!==null?new Br(e,this.data,this.fieldMask,n,this.fieldTransforms):new Ea(e,this.data,n,this.fieldTransforms)}}class h1{constructor(e,n,r){this.data=e,this.fieldMask=n,this.fieldTransforms=r}toMutation(e,n){return new Br(e,this.data,this.fieldMask,n,this.fieldTransforms)}}function d1(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw J()}}class xm{constructor(e,n,r,i,s,o){this.settings=e,this.databaseId=n,this.serializer=r,this.ignoreUndefinedProperties=i,s===void 0&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new xm(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var n;const r=(n=this.path)===null||n===void 0?void 0:n.child(e),i=this.Fu({path:r,xu:!1});return i.Ou(e),i}Nu(e){var n;const r=(n=this.path)===null||n===void 0?void 0:n.child(e),i=this.Fu({path:r,xu:!1});return i.vu(),i}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return Nu(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(d1(this.Cu)&&lM.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class cM{constructor(e,n,r){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=r||dc(e)}Qu(e,n,r,i=!1){return new xm({Cu:e,methodName:n,qu:r,path:et.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function f1(t){const e=t._freezeSettings(),n=dc(t._databaseId);return new cM(t._databaseId,!!e.ignoreUndefinedProperties,n)}function hM(t,e,n,r,i,s={}){const o=t.Qu(s.merge||s.mergeFields?2:0,e,n,i);Tm("Data must be an object, but it was:",o,r);const a=p1(r,o);let u,c;if(s.merge)u=new Lt(o.fieldMask),c=o.fieldTransforms;else if(s.mergeFields){const d=[];for(const f of s.mergeFields){const p=_f(e,f,n);if(!o.contains(p))throw new Q(z.INVALID_ARGUMENT,`Field '${p}' is specified in your field mask but missing from your input data.`);g1(d,p)||d.push(p)}u=new Lt(d),c=o.fieldTransforms.filter(f=>u.covers(f.field))}else u=null,c=o.fieldTransforms;return new uM(new At(a),u,c)}class vc extends vm{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof vc}}function dM(t,e,n,r){const i=t.Qu(1,e,n);Tm("Data must be an object, but it was:",i,r);const s=[],o=At.empty();Ii(r,(u,c)=>{const d=Em(e,u,n);c=mn(c);const f=i.Nu(d);if(c instanceof vc)s.push(d);else{const p=_c(c,f);p!=null&&(s.push(d),o.set(d,p))}});const a=new Lt(s);return new h1(o,a,i.fieldTransforms)}function fM(t,e,n,r,i,s){const o=t.Qu(1,e,n),a=[_f(e,r,n)],u=[i];if(s.length%2!=0)throw new Q(z.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let p=0;p<s.length;p+=2)a.push(_f(e,s[p])),u.push(s[p+1]);const c=[],d=At.empty();for(let p=a.length-1;p>=0;--p)if(!g1(c,a[p])){const g=a[p];let T=u[p];T=mn(T);const P=o.Nu(g);if(T instanceof vc)c.push(g);else{const R=_c(T,P);R!=null&&(c.push(g),d.set(g,R))}}const f=new Lt(c);return new h1(d,f,o.fieldTransforms)}function _c(t,e){if(m1(t=mn(t)))return Tm("Unsupported field value:",e,t),p1(t,e);if(t instanceof vm)return function(r,i){if(!d1(i.Cu))throw i.Bu(`${r._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Bu(`${r._methodName}() is not currently supported inside arrays`);const s=r._toFieldTransform(i);s&&i.fieldTransforms.push(s)}(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(r,i){const s=[];let o=0;for(const a of r){let u=_c(a,i.Lu(o));u==null&&(u={nullValue:"NULL_VALUE"}),s.push(u),o++}return{arrayValue:{values:s}}}(t,e)}return function(r,i){if((r=mn(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return sD(i.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const s=We.fromDate(r);return{timestampValue:bu(i.serializer,s)}}if(r instanceof We){const s=new We(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:bu(i.serializer,s)}}if(r instanceof _m)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Ts)return{bytesValue:LE(i.serializer,r._byteString)};if(r instanceof Ft){const s=i.databaseId,o=r.firestore._databaseId;if(!o.isEqual(s))throw i.Bu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:sm(r.firestore._databaseId||i.databaseId,r._key.path)}}if(r instanceof wm)return function(o,a){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:o.toArray().map(u=>{if(typeof u!="number")throw a.Bu("VectorValues must only contain numeric values.");return tm(a.serializer,u)})}}}}}}(r,i);throw i.Bu(`Unsupported field value: ${ym(r)}`)}(t,e)}function p1(t,e){const n={};return dE(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Ii(t,(r,i)=>{const s=_c(i,e.Mu(r));s!=null&&(n[r]=s)}),{mapValue:{fields:n}}}function m1(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof We||t instanceof _m||t instanceof Ts||t instanceof Ft||t instanceof vm||t instanceof wm)}function Tm(t,e,n){if(!m1(n)||!function(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}(n)){const r=ym(n);throw r==="an object"?e.Bu(t+" a custom object"):e.Bu(t+" "+r)}}function _f(t,e,n){if((e=mn(e))instanceof yc)return e._internalPath;if(typeof e=="string")return Em(t,e);throw Nu("Field path arguments must be of type string or ",t,!1,void 0,n)}const pM=new RegExp("[~\\*/\\[\\]]");function Em(t,e,n){if(e.search(pM)>=0)throw Nu(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new yc(...e.split("."))._internalPath}catch{throw Nu(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Nu(t,e,n,r,i){const s=r&&!r.isEmpty(),o=i!==void 0;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let u="";return(s||o)&&(u+=" (found",s&&(u+=` in field ${r}`),o&&(u+=` in document ${i}`),u+=")"),new Q(z.INVALID_ARGUMENT,a+t+u)}function g1(t,e){return t.some(n=>n.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class _1 extends y1{constructor(e,n,r,i,s,o){super(e,n,r,i,o),this._firestore=e,this._firestoreImpl=e,this.metadata=s}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new $l(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const r=this._document.data.field(v1("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,n.serverTimestamps)}}}class $l extends _1{data(e={}){return super.data(e)}}class _M{constructor(e,n,r,i){this._firestore=e,this._userDataWriter=n,this._snapshot=i,this.metadata=new vo(i.hasPendingWrites,i.fromCache),this.query=r}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(r=>{e.call(n,new $l(this._firestore,this._userDataWriter,r.key,r,new vo(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new Q(z.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(i,s){if(i._snapshot.oldDocs.isEmpty()){let o=0;return i._snapshot.docChanges.map(a=>{const u=new $l(i._firestore,i._userDataWriter,a.doc.key,a.doc,new vo(i._snapshot.mutatedKeys.has(a.doc.key),i._snapshot.fromCache),i.query.converter);return a.doc,{type:"added",doc:u,oldIndex:-1,newIndex:o++}})}{let o=i._snapshot.oldDocs;return i._snapshot.docChanges.filter(a=>s||a.type!==3).map(a=>{const u=new $l(i._firestore,i._userDataWriter,a.doc.key,a.doc,new vo(i._snapshot.mutatedKeys.has(a.doc.key),i._snapshot.fromCache),i.query.converter);let c=-1,d=-1;return a.type!==0&&(c=o.indexOf(a.doc.key),o=o.delete(a.doc.key)),a.type!==1&&(o=o.add(a.doc),d=o.indexOf(a.doc.key)),{type:wM(a.type),doc:u,oldIndex:c,newIndex:d}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function wM(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return J()}}class w1 extends yM{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ts(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ft(this.firestore,null,n)}}function j0(t,e,n,...r){t=Ir(t,Ft);const i=Ir(t.firestore,xs),s=f1(i);let o;return o=typeof(e=mn(e))=="string"||e instanceof yc?fM(s,"updateDoc",t._key,e,n,r):dM(s,"updateDoc",t._key,e),Sm(i,[o.toMutation(t._key,fn.exists(!0))])}function xM(t){return Sm(Ir(t.firestore,xs),[new nm(t._key,fn.none())])}function TM(t,e){const n=Ir(t.firestore,xs),r=Ul(t),i=vM(t.converter,e);return Sm(n,[hM(f1(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,fn.exists(!1))]).then(()=>r)}function EM(t,...e){var n,r,i;t=mn(t);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||O0(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(O0(e[o])){const f=e[o];e[o]=(n=f.next)===null||n===void 0?void 0:n.bind(f),e[o+1]=(r=f.error)===null||r===void 0?void 0:r.bind(f),e[o+2]=(i=f.complete)===null||i===void 0?void 0:i.bind(f)}let u,c,d;if(t instanceof Ft)c=Ir(t.firestore,xs),d=em(t._key.path),u={next:f=>{e[o]&&e[o](SM(c,t,f))},error:e[o+1],complete:e[o+2]};else{const f=Ir(t,gc);c=Ir(f.firestore,xs),d=f._query;const p=new w1(c);u={next:g=>{e[o]&&e[o](new _M(c,p,f,g))},error:e[o+1],complete:e[o+2]},gM(t._query)}return function(p,g,T,P){const R=new eM(P),x=new LN(g,R,T);return p.asyncQueue.enqueueAndForget(async()=>VN(await R0(p),x)),()=>{R.Za(),p.asyncQueue.enqueueAndForget(async()=>DN(await R0(p),x))}}(c1(c),d,a,u)}function Sm(t,e){return function(r,i){const s=new di;return r.asyncQueue.enqueueAndForget(async()=>KN(await rM(r),i,s)),s.promise}(c1(t),e)}function SM(t,e,n){const r=n.docs.get(e._key),i=new w1(t);return new _1(t,i,e._key,r,new vo(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){ks=i})(aV),br(new qn("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),a=new xs(new xV(r.getProvider("auth-internal")),new IV(r.getProvider("app-check-internal")),function(c,d){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new Q(z.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new aa(c.options.projectId,d)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),a._setSettings(s),a},"PUBLIC").setMultipleInstances(!0)),An(Zv,"4.7.3",e),An(Zv,"4.7.3","esm2017")})();const x1="@firebase/installations",Im="0.6.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GM({appConfig:t,heartbeatServiceProvider:e},n){const r=QM(t,n),i=RM(t,n),s=e.getImmediate({optional:!0});if(s){const c=await s.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={installation:{sdkVersion:E1,appId:t.appId}},a={method:"POST",headers:i,body:JSON.stringify(o)},u=await R1(()=>fetch(r,a));if(u.ok){const c=await u.json();return C1(c)}else throw await P1("Generate Auth Token",u)}function QM(t,{fid:e}){return`${A1(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
📉 ЗАЛИШОК (ДОПЛАТА): ${Bs} грн`;await G4(Et,Ht),Pa(!0),E([]),Wt(!1),setTimeout(()=>{k(!1),Te({fullName:"",phone:"",city:"",novaPoshta:""}),ot(null),H(null),ie(!1),ge(!1),gt(null),Pa(!1),C(1)},3e3)},Ra=()=>{const L=re.phone||"номер не вказано",G=`Вітаю! Хочу замовити товари з кошика на суму ${Vn} грн. Мій номер: ${L}`;return`https://t.me/vibestore_manager?text=${encodeURIComponent(G)}`},ba=[{name:"Діма",text:"Якість просто пушка! Рекомендую однозначно."},{name:"Оля",text:"Оригінал 100%, розмір підійшов ідеально, дякую!"},{name:"Макс",text:"Доставка швидка, менеджери топ. Буду брати ще."},{name:"Катя",text:"Дуже зручні, виглядають вживу ще краще, ніж на фото."},{name:"Влад",text:"Легіт чек пройшли, все чітко. Респект магазину."}];return v.jsxs("div",{className:"app-container",children:[v.jsxs("header",{className:"main-header",children:[v.jsxs("div",{className:"nav-buttons",children:[v.jsx("button",{onClick:()=>f(!0),className:"nav-pill-btn",children:"КАТАЛОГ"}),v.jsxs("button",{onClick:()=>c(!0),className:"nav-pill-btn",children:["КОШИК [",y.length,"]"]})]}),v.jsx("div",{className:"logo-wrap",children:v.jsx("h1",{className:"main-logo",onClick:Vs,children:"VIBE STORE"})})]}),t&&window.innerWidth>=1024&&v.jsxs("div",{className:"admin-panel",children:[v.jsxs("div",{className:"admin-panel-header",children:[v.jsx("h2",{children:"⚡ Панель керування"}),v.jsx("button",{className:"admin-close-btn",onClick:()=>e(!1),children:"✕"})]}),v.jsxs("div",{className:"admin-form",children:[v.jsx("input",{id:"p-name",type:"text",placeholder:"Назва товару",className:"admin-input"}),v.jsxs("div",{className:"admin-row",children:[v.jsx("input",{id:"p-price",type:"number",placeholder:"Ціна (UAH)",className:"admin-input"}),v.jsxs("select",{id:"p-category",className:"admin-input",children:[v.jsx("option",{value:"",children:"Категорія"}),v.jsx("option",{value:"Футболки",children:"Футболки"}),v.jsx("option",{value:"Худі та світшоти",children:"Худі та світшоти"}),v.jsx("option",{value:"Штани та джинси",children:"Штани та джинси"}),v.jsx("option",{value:"Шорти",children:"Шорти"}),v.jsx("option",{value:"Кросівки",children:"Кросівки"}),v.jsx("option",{value:"Аксесуари",children:"Аксесуари"})]})]}),v.jsx("textarea",{id:"p-desc",placeholder:"Опис (розміри, матеріал...)",rows:"3",className:"admin-input"}),v.jsxs("div",{className:"file-zone",children:[v.jsx("label",{className:"file-label",children:"📸 Фото товару (можна декілька)"}),v.jsx("input",{type:"file",id:"p-file",accept:"image/*",multiple:!0,style:{display:"none"}}),v.jsx("button",{className:"file-trigger",onClick:()=>document.getElementById("p-file").click(),children:"Вибрати файли"})]}),v.jsx("button",{onClick:Ds,className:"admin-submit",disabled:V,style:{opacity:V?.6:1},children:V?"Публікація...":"➕ Опублікувати товар"})]})]}),v.jsx("div",{className:`drawer-overlay ${d||u?"visible":""}`,onClick:()=>{f(!1),c(!1)}}),v.jsxs("div",{className:`side-drawer left-drawer ${d?"open":""}`,children:[v.jsx(Mh,{onClick:()=>f(!1)}),v.jsx("h2",{className:"drawer-title",children:"КАТАЛОГ"}),v.jsxs("div",{className:"catalog-content",children:[v.jsx("div",{className:"catalog-section",children:v.jsx("ul",{className:"catalog-list",children:v.jsx("li",{onClick:()=>Zn("Всі"),className:R==="Всі"?"active-category":"",children:"ВСІ ТОВАРИ"})})}),v.jsxs("div",{className:"catalog-section",children:[v.jsx("h3",{className:"catalog-subtitle",children:"ОДЯГ"}),v.jsx("ul",{className:"catalog-list",children:["Футболки","Худі та світшоти","Штани та джинси","Шорти"].map(L=>v.jsx("li",{onClick:()=>Zn(L),className:R===L?"active-category":"",children:L},L))})]}),v.jsxs("div",{className:"catalog-section",children:[v.jsx("h3",{className:"catalog-subtitle",children:"ВЗУТТЯ"}),v.jsx("ul",{className:"catalog-list",children:v.jsx("li",{onClick:()=>Zn("Кросівки"),className:R==="Кросівки"?"active-category":"",children:"Кросівки"})})]}),v.jsxs("div",{className:"catalog-section",children:[v.jsx("h3",{className:"catalog-subtitle",children:"АКСЕСУАРИ"}),v.jsx("ul",{className:"catalog-list",children:v.jsx("li",{onClick:()=>Zn("Аксесуари"),className:R==="Аксесуари"?"active-category":"",children:"Аксесуари"})})]})]})]}),v.jsxs("div",{className:`side-drawer right-drawer ${u?"open":""}`,children:[v.jsx(Mh,{onClick:()=>c(!1)}),v.jsx("h2",{className:"drawer-title",children:"КОШИК"}),v.jsx("div",{className:"cart-items-container",children:y.length===0?v.jsxs("div",{className:"empty-cart-message",children:[v.jsx("span",{style:{fontSize:"40px"},children:"🛒"}),v.jsx("p",{children:"Ваш кошик порожній"})]}):y.map(L=>{var G;return v.jsx("div",{className:"cart-item",children:v.jsxs("div",{className:"cart-item-row",children:[v.jsx("img",{src:((G=L.images)==null?void 0:G[0])||"https://via.placeholder.com/50",alt:L.name,className:"cart-item-img"}),v.jsxs("div",{className:"cart-item-info",children:[v.jsx("p",{className:"cart-item-name",children:L.name}),v.jsxs("p",{className:"cart-item-size",children:["РОЗМІР: ",L.chosenSize]})]}),v.jsxs("div",{className:"cart-item-price-block",children:[v.jsxs("p",{className:"cart-item-price",children:[L.price," UAH"]}),v.jsx("div",{className:"cart-item-delete",onClick:()=>E(y.filter(he=>he.cartId!==L.cartId)),children:v.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[v.jsx("polyline",{points:"3 6 5 6 21 6"}),v.jsx("path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})]})})]})]})},L.cartId)})}),y.length>0&&v.jsxs("div",{className:"cart-footer",children:[v.jsxs("div",{className:"cart-total",children:[v.jsx("span",{children:"РАЗОМ:"}),v.jsxs("span",{className:"cart-total-price",children:[Vn.toLocaleString()," UAH"]})]}),v.jsx("button",{onClick:Fs,className:"checkout-main-btn",children:"ОФОРМИТИ ЗАМОВЛЕННЯ"})]})]}),v.jsxs("main",{className:"main-content",children:[v.jsxs("section",{className:"hero-section",children:[v.jsxs("div",{className:"hero-mobile",children:[v.jsx("img",{src:q0,alt:"VIBE STORE",className:"hero-mobile-img"}),v.jsx("button",{onClick:()=>{var L;return(L=gn.current)==null?void 0:L.scrollIntoView({behavior:"smooth"})},className:"cta-button cta-mobile",children:"ПРИДБАТИ ОДЯГ"}),v.jsx("div",{className:"hero-description-box",children:v.jsxs("div",{className:"animated-gradient-box",children:["VIBE STORE — це онлайн магазин люксових речей під замовлення з Китаю 🇨🇳",v.jsx("br",{}),v.jsx("br",{}),"Ми підбираємо одяг, взуття та аксесуари під клієнта з увагою до деталей: розмір, колір і якість.",v.jsx("br",{}),v.jsx("br",{}),"Працюємо чесно і прозоро, супроводжуємо замовлення від покупки до отримання.",v.jsx("br",{}),v.jsx("br",{}),"⭐️ 500+ позитивних відгуків",v.jsx("br",{}),v.jsx("br",{}),"VIBE STORE — коли хочеш виглядати стильно без переплат 💙"]})})]}),v.jsxs("div",{className:"hero-desktop",children:[v.jsx("img",{src:q0,alt:"VIBE STORE",className:"hero-desktop-img"}),v.jsx("button",{onClick:()=>{var L;return(L=gn.current)==null?void 0:L.scrollIntoView({behavior:"smooth"})},className:"cta-button",children:"ПРИДБАТИ ОДЯГ"}),v.jsx("div",{className:"hero-description-box",children:v.jsxs("div",{className:"animated-gradient-box",children:["VIBE STORE — це онлайн магазин люксових речей під замовлення з Китаю 🇨🇳",v.jsx("br",{}),v.jsx("br",{}),"Ми підбираємо одяг, взуття та аксесуари під клієнта з увагою до деталей: розмір, колір і якість.",v.jsx("br",{}),v.jsx("br",{}),"Працюємо чесно і прозоро, супроводжуємо замовлення від покупки до отримання.",v.jsx("br",{}),v.jsx("br",{}),"⭐️ 500+ позитивних відгуків",v.jsx("br",{}),v.jsx("br",{}),"VIBE STORE — коли хочеш виглядати стильно без переплат 💙"]})})]})]}),v.jsxs("section",{ref:gn,className:"shop-section",children:[v.jsx("h2",{className:"animated-title",children:"NEW DROPS"}),v.jsxs("div",{className:"slider-container",children:[v.jsx("button",{className:"slider-nav-btn prev",onClick:()=>Ls("left"),children:v.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",children:v.jsx("polyline",{points:"15 18 9 12 15 6"})})}),v.jsx("div",{className:"products-scroll-container",ref:yn,children:O.map(L=>v.jsx("div",{onClick:()=>s(L),className:"product-scroll-anim",children:v.jsxs("div",{className:"product-card",children:[t&&v.jsx("div",{className:"delete-icon",onClick:G=>Ns(L.id,G),children:"🗑️"}),v.jsx("div",{className:"product-image-wrapper",children:v.jsx("img",{src:L.images[0],alt:L.name,className:"product-image"})}),v.jsx("h3",{className:"product-title",children:L.name}),v.jsxs("p",{className:"product-price",children:[L.price," UAH"]})]})},L.id))}),v.jsx("button",{className:"slider-nav-btn next",onClick:()=>Ls("right"),children:v.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",children:v.jsx("polyline",{points:"9 18 15 12 9 6"})})})]})]}),v.jsxs("section",{ref:Jn,className:"shop-section all-products-section",children:[v.jsx("h2",{className:"animated-title",children:R==="Всі"?"ВСІ ТОВАРИ":R.toUpperCase()}),Ms.length===0?v.jsxs("div",{className:"no-products",children:[v.jsx("p",{children:"Нічого не знайдено :("}),v.jsx("button",{onClick:()=>x("Всі"),className:"reset-filter",children:"Скинути фільтри"})]}):v.jsx("div",{className:"all-products-grid",children:Ms.map(L=>v.jsx("div",{onClick:()=>s(L),className:"product-scroll-anim",children:v.jsxs("div",{className:"product-card",children:[t&&v.jsx("div",{className:"delete-icon",onClick:G=>Ns(L.id,G),children:"🗑️"}),v.jsx("div",{className:"product-image-wrapper",children:v.jsx("img",{src:L.images[0],alt:L.name,className:"product-image"})}),v.jsx("h3",{className:"product-title",children:L.name}),v.jsxs("p",{className:"product-price",children:[L.price," UAH"]})]})},L.id))})]})]}),v.jsxs("footer",{className:"main-footer",children:[v.jsxs("div",{className:"footer-content",children:[v.jsxs("div",{className:"footer-logo-section",children:[v.jsx("h2",{className:"footer-logo",children:"VIBE STORE"}),v.jsx("p",{children:"Твій стиль. Твій вибір."})]}),v.jsxs("div",{className:"footer-links",children:[v.jsxs("div",{className:"footer-column",children:[v.jsx("h4",{children:"Клієнтам"}),v.jsx("span",{onClick:()=>I(!0),className:"footer-link",children:"Доставка та оплата"})]}),v.jsxs("div",{className:"footer-column",children:[v.jsx("h4",{children:"Соцмережі"}),v.jsx("span",{onClick:()=>window.open("https://www.instagram.com/vibestoree.ua?igsh=MTZhcHVxOXpqMzZxbA%3D%3D&utm_source=qr","_blank"),className:"footer-link",children:"Instagram"}),v.jsx("span",{onClick:()=>window.open("https://www.tiktok.com/@vibestore.ua?_r=1&_t=ZS-95VPaeqVzoz","_blank"),className:"footer-link",children:"TikTok"})]})]})]}),v.jsx("div",{className:"footer-bottom",children:v.jsx("p",{children:"© 2026 VIBE STORE. Всі права захищені."})})]}),i&&v.jsx("div",{className:`modal-overlay ${T?"closing":""}`,onClick:Os,children:v.jsxs("div",{className:`compact-modal ${T?"closing":""}`,onClick:L=>L.stopPropagation(),children:[v.jsx("div",{className:"modal-close-pos",children:v.jsx(Mh,{onClick:Os})}),v.jsx("div",{className:"modal-drag-indicator"}),v.jsxs("div",{className:"slider-modal-container",children:[v.jsx("div",{className:"slider-image-wrapper",children:v.jsx("img",{src:i.images[i.currentImageIndex],alt:i.name,className:"slider-image"},i.currentImageIndex)}),i.images.length>1&&v.jsxs(v.Fragment,{children:[v.jsx("button",{className:"slider-arrow slider-arrow-left",onClick:Ec,children:v.jsx("svg",{width:"26",height:"26",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:v.jsx("polyline",{points:"15 18 9 12 15 6"})})}),v.jsx("button",{className:"slider-arrow slider-arrow-right",onClick:Tc,children:v.jsx("svg",{width:"26",height:"26",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:v.jsx("polyline",{points:"9 18 15 12 9 6"})})}),v.jsxs("div",{className:"slider-counter",children:[i.currentImageIndex+1," / ",i.images.length]})]})]}),v.jsx("h2",{className:"modal-product-title",children:i.name}),v.jsx("p",{className:"modal-product-desc",children:i.desc||i.description}),v.jsx("p",{className:"modal-size-label",children:"ОБЕРІТЬ РОЗМІР"}),v.jsx("div",{className:"modal-sizes",children:(Ci=i.sizes)==null?void 0:Ci.map(L=>v.jsx("div",{onClick:()=>a(L),className:`size-btn ${o===L?"selected":""}`,children:L},L))}),v.jsx("button",{onClick:()=>js(i),className:`main-action-btn ${p?"success":""}`,children:p?"ГАРНИЙ ВИБІР ✓":`ДОДАТИ — ${i.price} UAH`}),v.jsxs("div",{className:"reviews-section",children:[v.jsx("h3",{children:"ВІДГУКИ КЛІЄНТІВ"}),ba.slice(0,3).map((L,G)=>v.jsxs("div",{className:"review-card",children:[v.jsxs("div",{className:"review-header",children:[v.jsx("span",{className:"review-name",children:L.name}),v.jsx("span",{className:"review-stars",children:"★★★★★"})]}),v.jsx("p",{className:"review-text",children:L.text})]},G))]})]})}),w&&v.jsx("div",{className:"rules-overlay",onClick:()=>I(!1),children:v.jsxs("div",{className:"rules-modal",onClick:L=>L.stopPropagation(),children:[v.jsx("button",{className:"rules-close",onClick:()=>I(!1),children:"✕"}),v.jsx("h2",{className:"rules-title",children:"📜 ПРАВИЛА ТА УМОВИ"}),v.jsxs("div",{className:"rules-content",children:[v.jsx("h3",{children:"1. Загальні положення"}),v.jsx("p",{children:"Інтернет-магазин VIBE STORE здійснює продаж товарів під замовлення. Оформлюючи замовлення, ви погоджуєтесь з умовами, викладеними нижче."}),v.jsx("h3",{children:"2. Оплата"}),v.jsx("p",{children:"Оплата здійснюється на карту ПриватБанку або MonoBank після підтвердження замовлення менеджером. Повна передоплата 100%."}),v.jsx("h3",{children:"3. Доставка"}),v.jsx("p",{children:"Доставка по Україні Новою Поштою або Укрпоштою протягом 7-21 днів з моменту замовлення. Вартість доставки сплачує покупець."}),v.jsx("h3",{children:"4. Повернення та обмін"}),v.jsx("p",{children:"Товари належної якості поверненню не підлягають, оскільки замовляються індивідуально. У разі виявлення браку проводиться обмін."}),v.jsx("h3",{children:"5. Конфіденційність"}),v.jsx("p",{children:"Ваші персональні дані використовуються виключно для обробки замовлення і не передаються третім особам."}),v.jsx("p",{children:"Дякуємо, що обираєте VIBE STORE!"})]})]})}),v.jsx(VR,{children:S&&v.jsx(oo.div,{className:"fullscreen-checkout-overlay",initial:{y:"100%",opacity:0},animate:{y:0,opacity:1},exit:{y:"100%",opacity:0},transition:{type:"spring",damping:30,stiffness:300},children:v.jsxs("div",{className:"checkout-container",children:[v.jsx("button",{className:"checkout-close-btn",onClick:ka,children:v.jsx("span",{style:{fontSize:"28px",lineHeight:1},children:"✕"})}),Ca?v.jsxs(oo.div,{className:"checkout-success-full",initial:{scale:.8,opacity:0},animate:{scale:1,opacity:1},children:[v.jsx("div",{className:"success-icon",children:"✓"}),v.jsx("h2",{children:"Дякуємо!"}),v.jsx("p",{children:"Ваше замовлення прийнято. Менеджер перевірить оплату та зв'яжеться з вами."})]}):v.jsxs("div",{className:"checkout-content",children:[v.jsxs("div",{className:"step-indicator",children:[v.jsxs("div",{className:`step ${b>=1?"active":""}`,children:[v.jsx("span",{children:"1"})," Доставка"]}),v.jsx("div",{className:`step-line ${b>=2?"active":""}`}),v.jsxs("div",{className:`step ${b>=2?"active":""}`,children:[v.jsx("span",{children:"2"})," Оплата"]}),v.jsx("div",{className:`step-line ${b>=3?"active":""}`}),v.jsxs("div",{className:`step ${b>=3?"active":""}`,children:[v.jsx("span",{children:"3"})," Підтвердження"]})]}),v.jsxs("div",{className:"checkout-step-content",children:[b===1&&v.jsxs(oo.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},exit:{opacity:0,x:20},className:"step-panel",children:[v.jsx("h3",{children:"👤 Дані доставки"}),v.jsx("div",{className:"input-group",children:v.jsx("input",{type:"text",placeholder:"Повне ім'я",value:re.fullName,onChange:L=>Te({...re,fullName:L.target.value})})}),v.jsxs("div",{className:"input-group",children:[v.jsx("span",{className:"input-icon-emoji",children:"📱"}),v.jsx("input",{type:"tel",placeholder:"Телефон",value:re.phone,onChange:L=>Te({...re,phone:L.target.value})})]}),v.jsxs("div",{className:"input-group",children:[v.jsx("span",{className:"input-icon-emoji",children:"📍"}),v.jsx("input",{type:"text",placeholder:"Місто / Область",value:re.city,onChange:L=>Te({...re,city:L.target.value})})]}),v.jsxs("div",{className:"input-group",children:[v.jsx("span",{className:"input-icon-emoji",children:"📦"}),v.jsx("input",{type:"text",placeholder:"Відділення Нової Пошти",value:re.novaPoshta,onChange:L=>Te({...re,novaPoshta:L.target.value})})]}),v.jsx("button",{className:"step-next-btn",disabled:!He(),onClick:()=>C(2),children:"Далі →"}),v.jsx("div",{className:"telegram-manager-link",children:v.jsx("a",{href:Ra(),target:"_blank",rel:"noopener noreferrer",children:"✈️ Оформити через Telegram менеджера"})})]}),b===2&&v.jsxs(oo.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},exit:{opacity:0,x:20},className:"step-panel",children:[v.jsx("h3",{children:"💳 Спосіб оплати"}),v.jsxs("div",{className:"payment-methods",children:[v.jsxs("div",{className:`payment-option ${Ee==="iban"?"active":""}`,onClick:()=>ot("iban"),children:[v.jsx("span",{children:"🏦"}),v.jsx("span",{children:"IBAN (ПУМБ)"})]}),v.jsxs("div",{className:`payment-option ${Ee==="card"?"active":""}`,onClick:()=>ot("card"),children:[v.jsx("span",{children:"💳"}),v.jsx("span",{children:"Карта Mono"})]})]}),v.jsx("h3",{style:{marginTop:"24px"},children:"📊 Тип оплати"}),v.jsxs("div",{className:"payment-methods",children:[v.jsxs("div",{className:`payment-option ${B==="full"?"active":""}`,onClick:()=>H("full"),children:[v.jsx("span",{children:"💰"}),v.jsx("span",{children:"Повна (100%)"})]}),v.jsxs("div",{className:`payment-option ${B==="partial"?"active":""}`,onClick:()=>H("partial"),children:[v.jsx("span",{children:"📅"}),v.jsx("span",{children:"Передплата (50%)"})]})]}),v.jsxs("div",{style:{marginTop:"24px",marginBottom:"16px"},children:[v.jsx("p",{style:{fontWeight:600,marginBottom:"12px",color:"#1a1a1a"},children:"🎧 Інструкція щодо оплати"}),v.jsx(Y4,{audioSrc:`${W4.PUBLIC_URL||""}/1234567.ogg`})]}),Ee&&v.jsxs("div",{className:"payment-details",children:[Ee==="card"&&v.jsxs(v.Fragment,{children:[v.jsxs("p",{children:[v.jsx("strong",{children:"Номер картки:"})," 4441 1144 0147 7805"]}),v.jsxs("p",{children:[v.jsx("strong",{children:"Отримувач:"})," Петров Д. О."]}),v.jsxs("p",{children:[v.jsx("strong",{children:"Банк:"})," MonoBank"]})]}),Ee==="iban"&&v.jsxs(v.Fragment,{children:[v.jsxs("p",{children:[v.jsx("strong",{children:"IBAN:"})," UA413348510000000026006332215"]}),v.jsxs("p",{children:[v.jsx("strong",{children:"Отримувач:"})," ФОП Петров Данило Олександрович"]}),v.jsxs("p",{children:[v.jsx("strong",{children:"Банк:"}),' АТ "ПУМБ"']})]})]}),B&&v.jsxs("div",{className:"total-amount-box",children:[v.jsxs("div",{children:[v.jsx("div",{children:"До сплати зараз:"}),v.jsxs("div",{className:"total-value",children:[Ur.toLocaleString()," грн"]})]}),B==="partial"&&v.jsxs("div",{style:{marginTop:"12px",paddingTop:"12px",borderTop:"1px dashed #cbd5e1"},children:[v.jsx("div",{children:"Залишок при отриманні:"}),v.jsxs("div",{style:{fontSize:"20px",fontWeight:"700",color:"#64748b"},children:[Bs.toLocaleString()," грн"]})]})]}),v.jsx("button",{className:"step-next-btn",disabled:!Qe(),onClick:()=>C(3),children:"Я оплатив, перейти до підтвердження →"}),v.jsx("button",{className:"step-back-btn",onClick:()=>C(1),children:"← Назад"})]}),b===3&&v.jsxs(oo.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},exit:{opacity:0,x:20},className:"step-panel",children:[v.jsx("h3",{children:"📎 Підтвердження оплати"}),v.jsxs("div",{className:"screenshot-upload-section",children:[v.jsxs("label",{className:"screenshot-label",children:[v.jsx("span",{className:"screenshot-icon",children:"📸"})," Прикріпіть скриншот або квитанцію про оплату"]}),v.jsxs("div",{className:"screenshot-upload-area",onClick:()=>{var L;return(L=zr.current)==null?void 0:L.click()},children:[Et?v.jsxs("div",{className:"screenshot-preview",children:[v.jsxs("span",{children:["📎 ",Et.name]}),v.jsx("button",{className:"remove-screenshot",onClick:L=>{L.stopPropagation(),gt(null),zr.current.value=""},children:"✕"})]}):v.jsxs("div",{className:"upload-placeholder",children:[v.jsx("span",{children:"📸"}),v.jsx("span",{children:"Натисніть щоб вибрати файл"})]}),v.jsx("input",{ref:zr,type:"file",accept:"image/*",style:{display:"none"},onChange:L=>{var G;(G=L.target.files)!=null&&G[0]&&gt(L.target.files[0])}})]})]}),v.jsxs("label",{className:"payment-confirm-checkbox",children:[v.jsx("input",{type:"checkbox",checked:Y,onChange:L=>ie(L.target.checked)}),v.jsx("span",{children:"Я підтверджую оплату"})]}),v.jsxs("label",{className:"payment-confirm-checkbox",children:[v.jsx("input",{type:"checkbox",checked:le,onChange:L=>ge(L.target.checked)}),v.jsx("span",{children:"Я згоден з умовами надання послуг та політикою конфіденційності"})]}),v.jsx("button",{className:`confirm-order-btn ${er()?"active":"disabled"}`,disabled:!er()||Vt,onClick:$r,children:Vt?"ВІДПРАВЛЯЄМО...":"ПІДТВЕРДИТИ ЗАМОВЛЕННЯ"}),v.jsx("button",{className:"step-back-btn",onClick:()=>C(2),children:"← Назад"})]}),b===3&&v.jsxs("div",{className:"checkout-summary",children:[v.jsxs("h3",{children:[v.jsx("span",{children:"🛒"})," Ваше замовлення"]}),v.jsx("div",{className:"summary-items",children:y.map(L=>v.jsxs("div",{className:"summary-item",children:[v.jsxs("span",{className:"summary-item-name",children:[L.name," (",L.chosenSize,")"]}),v.jsxs("span",{className:"summary-item-price",children:[L.price," грн"]})]},L.cartId))}),v.jsxs("div",{className:"summary-total",children:[v.jsx("span",{children:"Разом"}),v.jsxs("span",{className:"total-amount",children:[Vn.toLocaleString()," грн"]})]}),v.jsxs("div",{className:"summary-note",children:[v.jsxs("p",{children:["До сплати зараз: ",v.jsxs("strong",{children:[Ur.toLocaleString()," грн"]})]}),B==="partial"&&v.jsxs("p",{children:["Залишок при отриманні: ",v.jsxs("strong",{children:[Bs.toLocaleString()," грн"]})]}),v.jsx("p",{style:{marginTop:"8px"},children:"Доставка Новою Поштою"})]})]})]})]})]})})}),v.jsx("style",{children:`
      ...
      `})]})}Lh.createRoot(document.getElementById("root")).render(v.jsx(kS.StrictMode,{children:v.jsx(X4,{})}));
